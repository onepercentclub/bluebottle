...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounting_bankaccount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account_nr', self.gf('django.db.models.fields.CharField')(max_length=35, blank=True)),
            ('account_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'accounting', ['BankAccount'])


    def backwards(self, orm):
        # Deleting model 'BankAccount'
        db.delete_table(u'accounting_bankaccount')
