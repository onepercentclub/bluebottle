...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BankTransactionTenant'
        db.create_table(u'accounting_banktransactiontenant', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=35)),
        ))
        db.send_create_signal(u'accounting', ['BankTransactionTenant'])

        # Adding field 'BankTransaction.tenant'
        db.add_column(u'accounting_banktransaction', 'tenant',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounting.BankTransactionTenant'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'BankTransactionTenant'
        db.delete_table(u'accounting_banktransactiontenant')

        # Deleting field 'BankTransaction.tenant'
        db.delete_column(u'accounting_banktransaction', 'tenant_id')


    models = {
        u'accounting.bankaccount': {
            'Meta': {'object_name': 'BankAccount'},
            'account_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'account_nr': ('django.db.models.fields.CharField', [], {'max_length': '35', 'blank': 'True'}),
        ...
        u'accounting.banktransaction': {
            ...
            'tenant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounting.BankTransactionTenant']", 'null': 'True', 'blank': 'True'})
        },
        ...
        u'accounting.banktransactiontenant': {
            'Meta': {'object_name': 'BankTransactionTenant'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
