...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlueBottleUser.skypename'
        db.add_column(u'accounts_bluebottleuser', 'skypename',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlueBottleUser.skypename'
        db.delete_column(u'accounts_bluebottleuser', 'skypename')
