...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlueBottleUser.facebook'
        db.add_column(u'accounts_bluebottleuser', 'facebook',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'BlueBottleUser.twitter'
        db.add_column(u'accounts_bluebottleuser', 'twitter',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlueBottleUser.facebook'
        db.delete_column(u'accounts_bluebottleuser', 'facebook')

        # Deleting field 'BlueBottleUser.twitter'
        db.delete_column(u'accounts_bluebottleuser', 'twitter')
