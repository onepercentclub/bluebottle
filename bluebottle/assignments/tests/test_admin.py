...
class TestAssignmentAdmin(BluebottleAdminTestCase):
    ...
    def test_delete_applicant_assignment_admin(self):
        ...
        data = {
            ...
            'contributors-INITIAL_FORMS': '3',
            'contributors-0-contributor_ptr': self.applicants[0].contributor_ptr_id,
            'contributors-0-activity': self.assignment.id,
            'contributors-0-user': self.applicants[0].user_id,
            'contributors-0-time_spent': self.applicants[0].time_spent,
            'contributors-0-motivation': self.applicants[0].motivation,
            'contributors-0-status': self.applicants[0].status,
            'contributors-0-DELETE': 'on',
            'contributors-1-contributor_ptr': self.applicants[1].contributor_ptr_id,
            'contributors-1-activity': self.assignment.id,
            'contributors-1-user': self.applicants[1].user_id,
            'contributors-1-time_spent': self.applicants[1].time_spent,
            'contributors-1-status': self.applicants[1].status,
            'contributors-2-contributor_ptr': self.applicants[2].contributor_ptr_id,
            'contributors-2-activity': self.assignment.id,
            'contributors-2-user': self.applicants[2].user_id,
            'contributors-2-time_spent': self.applicants[2].time_spent,
            'contributors-2-status': self.applicants[2].status,
            'contributors-2-DELETE': 'on',
        }
