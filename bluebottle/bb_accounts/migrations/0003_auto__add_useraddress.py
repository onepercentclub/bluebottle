...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('members_useraddress', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='address', unique=True, to=orm[MODEL_MAP['user']['model']])),
        ))
    ...
    models = {
        ...
        u'bb_accounts.useraddress': {
            'Meta': {'object_name': 'UserAddress', 'db_table': "'members_useraddress'"},
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'address'", 'unique': 'True', 'to': "orm['{0}']".format(MODEL_MAP['user']['model'])})
        },
