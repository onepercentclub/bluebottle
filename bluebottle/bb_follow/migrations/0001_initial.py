...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Follow'
        db.create_table(u'bb_follow_follow', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['members.BookingUser'])),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'bb_follow', ['Follow'])


    def backwards(self, orm):
        # Deleting model 'Follow'
        db.delete_table(u'bb_follow_follow')
    ...
    models = {
        ...
        u'bb_follow.follow': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['members.BookingUser']"})
        },
