...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bb_follow_follow', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['test.TestBaseUser'])),
    ...
    models = {
        ...
        u'bb_follow.follow': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['test.TestBaseUser']"})
        },
