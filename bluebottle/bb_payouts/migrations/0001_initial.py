...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'bb_payouts_projectpayoutlog', (
            ...
            ('new_status',
             self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('payout', self.gf('django.db.models.fields.related.ForeignKey')(
                related_name='project_payout_logs',
                to=orm[MODEL_MAP['project_payout']['model']])),
        ))
        ...
        db.create_table(u'bb_payouts_organizationpayoutlog', (
            ...
            ('new_status',
             self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('payout', self.gf('django.db.models.fields.related.ForeignKey')(
                related_name='organization_payout_logs',
                to=orm[MODEL_MAP['organization_payout']['model']])),
        ))
    ...
    models = {
        ...
        u'bb_payouts.organizationpayoutlog': {
            'Meta': {'ordering': "['-created']",
                     'object_name': 'OrganizationPayoutLog'},
            ...
            'old_status': ('django.db.models.fields.CharField', [],
                           {'max_length': '20', 'null': 'True',
                            'blank': 'True'}),
            'payout': ('django.db.models.fields.related.ForeignKey', [],
                       {'related_name': "'organization_payout_logs'",
                        'to': "orm['{0}']".format(
                            MODEL_MAP['organization_payout']['model'])})
        },
        u'bb_payouts.projectpayoutlog': {
            'Meta': {'ordering': "['-created']",
                     'object_name': 'ProjectPayoutLog'},
            'created': ('django.db.models.fields.DateTimeField', [],
                        {'default': 'datetime.datetime.now', 'blank': 'True'}),
            u'id': (
            'django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'payout': ('django.db.models.fields.related.ForeignKey', [],
                       {'related_name': "'project_payout_logs'",
                        'to': "orm['{0}']".format(
                            MODEL_MAP['project_payout']['model'])})
        },
        ...
        MODEL_MAP['organization_payout']['model_lower']: {
            'Meta': {'ordering': "['start_date']",
                     ...
                     'object_name': MODEL_MAP['organization_payout']['class']},
            ...
            'bluebottle.bb_projects.fields.MoneyField', [],
            ...
            'bluebottle.bb_projects.fields.MoneyField', [],
            {'max_digits': '12', 'decimal_places': '2'}),
            'other_costs_excl': ('bluebottle.bb_projects.fields.MoneyField', [],
                                 {'default': "'0.00'", 'max_digits': '12',
                                  'decimal_places': '2'}),
            'other_costs_incl': ('bluebottle.bb_projects.fields.MoneyField', [],
                                 {'default': "'0.00'", 'max_digits': '12',
                                  'decimal_places': '2'}),
            'other_costs_vat': ('bluebottle.bb_projects.fields.MoneyField', [],
                                {'default': "'0.00'", 'max_digits': '12',
                                 'decimal_places': '2'}),
            'payable_amount_excl': (
            'bluebottle.bb_projects.fields.MoneyField', [],
            ...
            'psp_fee_excl': ('bluebottle.bb_projects.fields.MoneyField', [],
                             {'max_digits': '12', 'decimal_places': '2'}),
            'psp_fee_incl': ('bluebottle.bb_projects.fields.MoneyField', [],
                             {'max_digits': '12', 'decimal_places': '2'}),
            'psp_fee_vat': ('bluebottle.bb_projects.fields.MoneyField', [],
                            {'max_digits': '12', 'decimal_places': '2'}),
        ...
        MODEL_MAP['project_payout']['model_lower']: {
            'Meta': {'ordering': "['-created']",
                     'object_name': MODEL_MAP['project_payout']['class']},
            'amount_payable': ('bluebottle.bb_projects.fields.MoneyField', [],
                               {'max_digits': '12', 'decimal_places': '2'}),
            'amount_raised': ('bluebottle.bb_projects.fields.MoneyField', [],
                              {'max_digits': '12', 'decimal_places': '2'}),
            'completed': ('django.db.models.fields.DateField', [],
                          {'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [],
                        {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'description_line1': ('django.db.models.fields.CharField', [],
                                  {'default': "''", 'max_length': '100',
                                   'blank': 'True'}),
            'description_line2': ('django.db.models.fields.CharField', [],
                                  {'default': "''", 'max_length': '100',
                                   'blank': 'True'}),
            'description_line3': ('django.db.models.fields.CharField', [],
                                  {'default': "''", 'max_length': '100',
                                   'blank': 'True'}),
            'description_line4': ('django.db.models.fields.CharField', [],
                                  {'default': "''", 'max_length': '100',
                                   'blank': 'True'}),
            u'id': (
            'django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice_reference': (
            'django.db.models.fields.CharField', [], {'max_length': '100'}),
            'organization_fee': ('bluebottle.bb_projects.fields.MoneyField', [],
                                 {'max_digits': '12', 'decimal_places': '2'}),
            'payout_rule': (
            'django.db.models.fields.CharField', [], {'max_length': '20'}),
            'planned': ('django.db.models.fields.DateField', [], {}),
            ...
            'receiver_account_bic': ('django.db.models.fields.CharField', [],
            ...
            'receiver_account_iban': ('django.db.models.fields.CharField', [],
                                      {'max_length': '100', 'blank': 'True'}),
            'receiver_account_name': (
            'django.db.models.fields.CharField', [], {'max_length': '100'}),
            'receiver_account_number': ('django.db.models.fields.CharField', [],
                                        {'max_length': '100', 'blank': 'True'}),
