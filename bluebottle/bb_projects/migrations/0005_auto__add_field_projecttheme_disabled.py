...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'ProjectTheme.disabled'
        db.add_column(u'bb_projects_projecttheme', 'disabled',
                      self.gf('django.db.models.fields.BooleanField')(
                          default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ProjectTheme.disabled'
        db.delete_column(u'bb_projects_projecttheme', 'disabled')
