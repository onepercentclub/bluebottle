...
class Migration(DataMigration):
    def forwards(self, orm):
        "Add vote stati."
        orm['bb_projects.ProjectPhase'].objects.create(id=11, viewable=True,
                                                       name='Voting',
                                                       slug='voting',
                                                       sequence=11,
                                                       editable=False,
                                                       active=True,
                                                       description='')
        orm['bb_projects.ProjectPhase'].objects.create(id=12, viewable=True,
                                                       name='Voting - Done',
                                                       slug='voting-done',
                                                       sequence=12,
                                                       editable=False,
