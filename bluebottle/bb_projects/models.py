...
class BaseProject(models.Model, GetTweetMixin):
    ...
    # Bank details
    account_iban = IBANField(_("account IBAN"), null=True, blank=True)
    ...
    account_bank_name = models.CharField(
        _("account bank name"), max_length=255, null=True, blank=True)
    account_bank_address = models.CharField(
        _("account bank address"), max_length=255, null=True, blank=True)
    account_bank_postal_code = models.CharField(
        _("account bank postal code"), max_length=20, null=True, blank=True)
    account_bank_city = models.CharField(
        _("account bank city"), max_length=255, null=True, blank=True)
