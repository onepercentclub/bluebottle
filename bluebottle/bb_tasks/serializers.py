...
class TaskPreviewSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'title', 'description', 'skill',
                  'status', 'created', 'project', 'deadline', 'time_needed')
...
class TaskFileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = TaskFile
        fields = ('id', 'author', 'file', 'created', 'title') #'task'
...
class TaskSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = BB_TASK_MODEL
        fields = ('id', 'title', 'project', 'description', 'members', 'files', 'skill',
                  'time_needed', 'author', 'status', 'created', 'deadline', 'meta_data',
        )
