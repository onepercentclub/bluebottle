!(function() {
...
})()(
  {
      ...
      function(t, e, i) {
        ...
        (s.prototype = {
          getContentWrappers: function() {
            var t = this.$changeform.find("#content-main > form > div"),
              e = t.find("> .module"),
          ...
          showTab: function(t, e) {
            var i = this.$changeform.find(".changeform-tabs-item"),
              ...
              s = this.getHashSelector(t);
            if (e || null != s) {
              (null != s && 0 != s.length) ||
                (s = this.getHashSelector(
                  i
                    .first()
                    .find(".changeform-tabs-item-link")
                    .attr("href")
                ));
              var o = n.filter("." + s),
                r = i
                  .find('.changeform-tabs-item-link[href="#/tab/' + s + '/"]')
          ...
          updateErrorState: function() {
            var t = this.$changeform.find(".changeform-tabs-item"),
              e = this.getContentWrappers(),
              i = this;
            t.each(function() {
              var t = n(this),
                s = i.getHashSelector(
                  t.find(".changeform-tabs-item-link").attr("href")
                );
              if (s) {
                var o = e.filter("." + s);
                o.find(".form-row.errors").length && t.addClass("errors");
              }
            });
          },
          run: function() {
      ...
      function(t, e, i) {
        ...
        (o.prototype = {
          ...
          onWindowBeforeUnload: function() {
            return s("Warning: you have unsaved changes");
          },
          onFormInputChanged: function(t) {
            t.off("change", this.onFormInputChanged),
              self.changeDetected ||
                n(window).bind("beforeunload", this.onWindowBeforeUnload),
              (this.changeDetected = !0);
          },
          initUnsavedChangesWarning: function(t) {
            var e = this,
              i = t.find("#content-main form");
            if (0 != i.length) {
              var s = i.find("input, textarea, select");
              n(document).on("submit", "form", function() {
                n(window).off("beforeunload", e.onWindowBeforeUnload);
              }),
                s.on("change", n.proxy(this.onFormInputChanged, this, s));
            }
          },
          run: function() {
            try {
      ...
      function(t, e, i) {
        ...
        (s.prototype = {
            ...
            if (0 != e.length) {
              var i = e.clone(),
                s = n("<table>")
                  .addClass("helper")
                  .append(i);
              s.find(".action-checkbox-column").empty(),
                s.appendTo(document.body),
                n(window).on(
                  "scroll",
                  n.proxy(this.updateFixedHeaderVisibility, this, s, e)
                ),
                n(window).on(
                  "resize",
                  n.proxy(this.updateFixedHeaderWidth, this, i, e)
                ),
                this.updateFixedHeaderWidth(i, e);
            }
          },
          updateFixedFooter: function(t, e) {
            if (
              n(window).scrollTop() + n(window).height() <
              t.offset().top + t.outerHeight(!1) + e.innerHeight()
            ) {
              if (!e.hasClass("fixed")) {
                var i = n(window).scrollTop();
                e.addClass("fixed"),
                  t.css("margin-bottom", e.innerHeight() + "px"),
                  n(window).scrollTop(i);
              }
            } else
              e.hasClass("fixed") &&
                (e.removeClass("fixed"), t.css("margin-bottom", 0));
          },
          initFixedFooter: function(t) {
            var e = t.find(".changelist-footer"),
              i = e.siblings(".results");
            0 != e.length &&
              0 != i.length &&
              (n(window).on(
                "scroll",
                n.proxy(this.updateFixedFooter, this, i, e)
              ),
              n(window).on(
                "resize",
                n.proxy(this.updateFixedFooter, this, i, e)
              ),
              this.updateFixedFooter(i, e));
          },
          ...
          initRowSelection: function(t) {
            t.find("#result_list tbody th, #result_list tbody td").on(
              "click",
              function(t) {
                t.target == this &&
                  n(this)
                    .closest("tr")
                    .find(".action-checkbox .action-select")
                    .click();
              }
            );
          },
          run: function() {
            ...
            try {
              this.initFixedHeader(t),
                this.initFixedFooter(t),
                this.initHeaderSortableSelection(t),
                this.initRowSelection(t);
            } catch (e) {
        ...
        (s.prototype = {
          ...
          addLabelToCheckboxes: function() {
            ...
            n('input[type="checkbox"]').each(function() {
              var e = n(this);
              (void 0 != e.attr("id") &&
                0 != n('label[for="' + e.attr("id") + '"]').length) ||
                t.addLabelToCheckbox(e);
            });
          },
          run: function() {
            try {
    ...
    5: [
      function(t, e, i) {
        var n = t("jquery"),
          s = function(t) {
            (this.$inline = t),
              (this.prefix = t.data("inline-prefix")),
              (this.verboseName = t.data("inline-verbose-name")),
              (this.deleteText = t.data("inline-delete-text"));
          };
        (s.prototype = {
          updateLabels: function(t) {
            var e = this,
              i = t.find(".inline-navigation-item");
            t.find(".inline-related").each(function(t) {
              var s = n(this),
                o = s.find(".inline_label"),
                r = o.html().replace(/(#\d+)/g, "#" + (t + 1)),
                a = i.eq(t),
                l = s.hasClass("has_original") ? r : e.verboseName + " " + r;
              o.html(r), a.html(l);
            });
          },
          updateFormIndex: function(t, e) {
            var i = new RegExp("(" + this.prefix + "-(\\d+|__prefix__))"),
              s = this.prefix + "-" + e;
            t.find("*").each(function() {
              var t = n(this);
              n.each(["for", "id", "name"], function() {
                var e = this;
                t.attr(e) && t.attr(e, t.attr(e).replace(i, s));
              });
            }),
          ...
          updateFormsIndexes: function(t) {
            ...
            t.find(".inline-related").each(function(t) {
              var s = n(this);
              e.updateFormIndex(s, t),
                i.eq(t).attr("data-inline-related-id", s.attr("id"));
            });
          },
          updateTotalForms: function(t) {
            var e = t.find('[name="' + this.prefix + '-TOTAL_FORMS"]'),
              i = t.find('[name="' + this.prefix + '-MAX_NUM_FORMS"]'),
              n = parseInt(t.find(".inline-related").length),
              s = i.val() ? parseInt(i.val()) : 1 / 0;
            e.val(n), t.find(".add-row").toggle(s >= n);
          },
          addNavigationItem: function(t, e) {
            ...
            return i
              .clone()
              .removeClass("empty")
              .attr("data-inline-related-id", e.attr("id"))
              .insertBefore(i);
          },
          openNavigationItem: function(t, e) {
            t
              ...
              .filter("#" + e.attr("data-inline-related-id"))
              .addClass("selected"),
              t.find(".inline-navigation-item").removeClass("selected"),
              e.addClass("selected");
          },
          removeItem: function(t, e) {
            e.remove(),
              t
                .find(
                  '.inline-navigation-item[data-inline-related-id="' +
                    e.attr("id") +
                    '"]'
                )
                .remove();
          ...
          openFirstNavigationItem: function(t) {
            ...
            void 0 != e &&
              (this.openNavigationItem(t, e), this.scrollNavigationToTop(t));
          },
          addItemDeleteButton: function(t) {
            t.children(":first").append(
              '<span><a class="inline-deletelink" href="#">' +
                this.deleteText +
                "</a></span>"
            );
          },
          ...
          initAdding: function(t) {
            ...
            t.find(".add-row a").on("click", function(i) {
              i.preventDefault();
              var n = t.find(".inline-related.empty-form"),
                s = parseInt(t.find(".inline-related").length) - 1,
                o = n
                  .clone(!0)
                  .removeClass("empty-form")
                  .insertBefore(n);
              e.updateTotalForms(t),
                e.updateFormIndex(o, s),
                e.updateFormIndex(n, s + 1);
              var r = e.addNavigationItem(t, o);
              e.updateLabels(t),
                e.openNavigationItem(t, r),
                e.addItemDeleteButton(o),
                e.scrollNavigationToBottom(t);
            });
          },
          initDeletion: function(t) {
            ...
            t.on("click", ".inline-deletelink", function(i) {
              i.preventDefault();
              var s = n(this).closest(".inline-related");
              e.removeItem(t, s),
                e.updateFormsIndexes(t),
                e.updateLabels(t),
                e.updateTotalForms(t),
                ...
                e.find(".delete input").on("change", function() {
                  t.find(
                    '.inline-navigation-item[data-inline-related-id="' +
                      e.attr("id") +
                      '"]'
                  ).toggleClass("delete", n(this).is(":checked"));
                });
              });
          },
    ...
    6: [
      function(t, e, i) {
        ...
        var n = t("jquery"),
          s = t("../utils/translate");
        t("jquery-ui/ui/core"),
          t("jquery-ui/ui/widget"),
          t("jquery-ui/ui/mouse"),
          t("jquery-ui/ui/draggable"),
          t("jquery-ui/ui/droppable"),
          t("jquery-ui/ui/sortable"),
          t("jquery-ui/ui/resizable"),
          t("jquery-ui/ui/button"),
          t("jquery-ui/ui/dialog");
        var o = function(t) {
          this.$dashboard = t;
        };
        (o.prototype = {
          initTools: function(t) {
            ...
            e.find(".add-dashboard-link").on("click", function(t) {
              ...
              t.find(".reset-dashboard-link").on("click", function(e) {
                ...
                (i[s("Yes")] = function() {
                  o(), n(this).dialog("close");
                }),
                  (i[s("Cancel")] = function() {
                    n(this).dialog("close");
                  }),
                  t
                    .find("#reset-dashboard-dialog")
                    .dialog({ resizable: !1, modal: !0, buttons: i }),
                  e.preventDefault();
              });
          },
          updateDashboardModules: function(t) {
            var e = t.find("#update-dashboard-modules-form"),
              i = [];
            t.find(".dashboard-column").each(function() {
              var t = n(this),
                e = t.closest(".dashboard-column-wrapper").index();
              t.find(".dashboard-item").each(function() {
                var t = n(this),
                  s = t.index(),
                  o = t.data("module-id");
                i.push({ id: o, column: e, order: s });
              });
            }),
              e.find('[name="modules"]').val(JSON.stringify(i)),
              n.ajax({
                url: e.attr("action"),
                method: e.attr("method"),
                dataType: "json",
          ...
          initCollapsibleModules: function(t) {
            ...
            t.find(".dashboard-item.collapsible").each(function() {
              var t = n(this),
                i = t.find(".dashboard-item-collapse"),
                s = t.find(".dashboard-item-content"),
                o = t.data("module-id");
              i.on("click", function(i) {
                i.preventDefault(),
                  s.slideFadeToggle(200, "swing", function() {
                    var i = 0 == s.is(":visible");
                    i ? t.addClass("collapsed") : t.removeClass("collapsed"),
                      e.find('[name="id"]').val(o),
                      e.find('[name="collapsed"]').val(i ? "true" : "false"),
                      n.ajax({
                        url: e.attr("action"),
                        method: e.attr("method"),
                        dataType: "json",
          ...
          initDeletableModules: function(t) {
            ...
            t.find(".dashboard-item.deletable").each(function() {
              var i = n(this),
                o = i.find(".dashboard-item-remove"),
                r = i.data("module-id");
              o.on("click", function(o) {
                ...
                (a[s("Delete")] = function() {
                  ...
                  t
                    .find("#module-remove-dialog")
                    .dialog({ resizable: !1, modal: !0, buttons: a });
              });
            });
          },
          initAjaxModules: function(t) {
            t.find(".dashboard-item.ajax").each(function() {
              var t = n(this),
                e = t.find(".dashboard-item-content"),
                i = t.data("ajax-url");
              n.ajax({
                url: i,
                dataType: "json",
                success: function(t) {
                  ...
                  var n = e.height();
                  e.height(i),
                    e.animate({ height: n }, 250, "swing", function() {
                      e.height("auto");
                    });
                },
                error: function() {
          ...
          updateModuleChildrenFormsetFormIndex: function(t, e) {
            var i = "children",
              s = new RegExp("(" + i + "-(\\d+|__prefix__))"),
              o = i + "-" + e;
            t.find("fieldset.module *").each(function() {
              var t = n(this);
              n.each(["for", "id", "name"], function() {
                var e = this;
                t.attr(e) && t.attr(e, t.attr(e).replace(s, o));
              });
            });
          },
          updateModuleChildrenFormsetFormsIndexes: function(t) {
            var e = this,
              i = parseInt(t.find(".inline-related.has_original").length);
          ...
          updateModuleChildrenFormsetTotalForms: function(t) {
            var e = t.find('[name="children-TOTAL_FORMS"]'),
              i = parseInt(t.find(".inline-related").length);
            e.val(i);
          },
              ...
              i.find(".add-row a").on("click", function(t) {
                ...
                var n = i.find(".inline-related.empty-form"),
                  s = n
                    ...
                    .removeClass("empty-form")
                    .insertBefore(n);
                e.updateModuleChildrenFormsetLabels(i),
                  e.updateModuleChildrenFormsetFormIndex(
                    n,
                    parseInt(i.find(".inline-related").length) - 1
                  ),
                  e.updateModuleChildrenFormsetFormIndex(
                    s,
                    parseInt(i.find(".inline-related").length) - 2
                  ),
                  e.updateModuleChildrenFormsetTotalForms(i);
              }),
                i.find(".inline-deletelink").on("click", function(t) {
                  t.preventDefault(),
                    n(this)
                      ...
                      .remove(),
                    e.updateModuleChildrenFormsetFormsIndexes(i),
                    e.updateModuleChildrenFormsetLabels(i),
                    e.updateModuleChildrenFormsetTotalForms(i);
                });
            }
          ...
          run: function() {
            ...
            try {
              this.initTools(t),
                this.initModulesDragAndDrop(t),
                this.initCollapsibleModules(t),
                this.initDeletableModules(t),
                this.initAjaxModules(t),
                this.initModuleChildrenFormsetUpdate(t);
            } catch (e) {
              console.error(e, e.stack);
            }
      ...
      function(t, e, i) {
        ...
        (s.prototype = {
          ...
          updateDatetimeLayout: function() {
            ...
            n(".form-row .datetime").each(function() {
              var e = n(this),
                i = e.find(".vDateField"),
                s = e.find(".vTimeField");
              t.removeInputTextNode(i),
                t.removeInputTextNode(s),
                i
                  .nextAll("br")
                  .first()
                  .remove();
              ...
              n(".form-row .vDateField").each(function() {
                var t = n(this),
                  e = n("<span>").addClass("icon-calendar");
                n("<a>")
                  .attr("href", "#")
            ...
            t.find(".form-row .vDateField").each(function() {
              ...
              t.datepicker({
                ...
                i.on("click", function(e) {
                  t.datepicker("widget").is(":visible")
                    ? t.datepicker("hide")
                    : t.datepicker("show"),
                    e.preventDefault();
                });
          ...
          initTimeWidgets: function(t) {
            (t = t || n(document)),
              t.find(".form-row .vTimeField").each(function() {
                var t = n(this),
                  e = t.next(".vTimeField-link");
                t.timepicker({
                  showPeriodLabels: !1,
                  showCloseButton: !0,
                  showNowButton: !0
        ...
        (s.prototype = {
          initFiltersInteraction: function(t) {
            t.find(".changelist-filter-select").each(function() {
              var t = n(this),
                e = t.attr("multiple");
              e && t.data("previous-options", t.find("option:selected")),
                t.on("change", function() {
                  var t = n(this),
                    i = t.find("option:selected");
                  e &&
                    (t.data("previous-options").length < i.length
                      ? (i = i.filter(function(e, i) {
                          return (
                            0 ==
                            t.data("previous-options").filter(function(t, e) {
                              return e == i;
                            }).length
                          );
                        }))
                      : t.data("previous-options").length > i.length &&
                        (i = t.data("previous-options").filter(function(t, e) {
                          return (
                            0 ==
                            i.filter(function(t, i) {
                              return e == i;
                            }).length
                          );
                        })),
                  ...
                  var s = i.data("url"),
                    o = t.data("queryset--lookup");
                  s
                    ? (document.location = i.data("url"))
                    : o && (document.location = "?" + o + "=" + i.val());
                });
            });
          },
          run: function() {
      ...
      function(t, e, i) {
        ...
        (o.prototype = {
          ...
          run: function() {
            var t = this.$inline;
            try {
              t.hasClass("compact") && new s(t).run(), this.initAddRow(t);
            } catch (e) {
              console.error(e, e.stack);
            }
            t.addClass("initialized");
    ...
    10: [
      function(t, e, i) {
        var n = t("jquery"),
          s = t("../utils/window-storage"),
          o = function() {
            this.windowStorage = new s("relatedWindows");
          };
        (o.prototype = {
          updateLinks: function(t) {
            t.find("~ .change-related, ~ .delete-related, ~ .add-another").each(
              function() {
                var e = n(this),
                  i = e.data("href-template");
                if (void 0 != i) {
                  var s = t.val();
                  s
                    ? e.attr("href", i.replace("__fk__", s))
                    : e.removeAttr("href");
                }
              }
            );
              ...
              t
                ...
                .each(function() {
                  ...
                  e.updateLinks(t),
                    t
                      .find(
                        "~ .add-related, ~ .change-related, ~ .delete-related, ~ .add-another"
                      )
                      .each(function() {
                        var i = n(this);
                ...
                t.find("input").each(function() {
                  ...
                  t.find("~ .related-lookup").each(function() {
                    ...
                    i.on("click", function(n) {
                      n.preventDefault();
                      var s = i.attr("href");
                      (s += s.indexOf("?") == -1 ? "?_popup=1" : "&_popup=1"),
                        e.showPopup(t, s);
                    });
                  });
                }),
          ...
          showPopup: function(t, e) {
            var i = n(window.top.document),
              s = i.find(".related-popup-container"),
              o = s.find(".loading-indicator"),
              r = i.find("body"),
              a = n("<div>")
              ...
              l = n("<iframe>")
                .attr("src", e)
                .on("load", function() {
                  a.add(i.find(".related-popup-back")).fadeIn(
                    200,
                    "swing",
                    function() {
                      o.hide();
            ...
            a.append(l),
              ...
              i
                .find(".related-popup")
                .add(i.find(".related-popup-back"))
                .fadeOut(200, "swing"),
              s.fadeIn(200, "swing", function() {
                s.append(a);
              }),
              r.addClass("non-scrollable");
          },
          closePopup: function(t) {
            var e = this.windowStorage.previous(),
              i = this;
            !(function(e) {
              var n = e(window.top.document),
                s = n.find(".related-popup"),
                o = n.find(".related-popup-container"),
                r = s.last();
              void 0 != t && i.processPopupResponse(r, t),
                i.windowStorage.pop(),
                1 == s.length
                  ? o.fadeOut(200, "swing", function() {
                      n.find(".related-popup-back").hide(),
                        n.find("body").removeClass("non-scrollable"),
                        r.remove();
                    })
                  : s.length > 1 && (r.remove(), s.eq(s.length - 2).show());
            })(e ? e.jet.jQuery : n);
          },
            ...
            switch (e.action) {
              ...
              default:
                if (i.is("select")) {
                  ...
                  i.is("input.vManyToManyRawIdAdminField") && i.val()
                    ? i.val(i.val() + "," + e.value)
                    : i.is("input") && i.val(e.value);
            }
          },
          overrideRelatedGlobals: function() {
            ...
            (window.showRelatedObjectLookupPopup = window.showAddAnotherPopup = window.showRelatedObjectPopup = function() {}),
              ...
              (window.dismissRelatedLookupPopup = function(e, i) {
                t.closePopup({ action: "lookup", value: i });
              });
          },
          initDeleteRelatedCancellation: function() {
            var t = this;
            n(".popup.delete-confirmation .cancel-link")
              .on("click", function(e) {
                e.preventDefault(), t.closePopup();
              })
              .removeAttr("onclick");
          ...
          initLookupLinks: function() {
            ...
            n("a[data-popup-opener]").click(function(e) {
              e.preventDefault(),
                t.closePopup({
                  action: "lookup",
                  value: n(this).data("popup-opener")
                });
            });
          },
          run: function() {
        ...
        (s.prototype = {
          ...
          initDetector: function() {
            ...
            n(window).on("scroll", function() {
              null != t.prevScrollTop &&
              n(window).scrollTop() > t.prevScrollTop &&
              n(window).scrollTop() > 60
                ? n(document.body).addClass("scroll-to-bottom")
                : n(document.body).removeClass("scroll-to-bottom"),
                (t.prevScrollTop = n(window).scrollTop());
            });
          },
          run: function() {
            try {
    ...
    12: [
      function(t, e, i) {
        ...
        (o.prototype = {
          updateAttachBody: function(t) {
            (t.prototype._positionDropdown = function() {
              ...
              var a = { height: this.$dropdown.outerHeight(!1) },
                ...
                h = { left: o.left, top: r.bottom };
              if (
                (e || i || (s = "below"),
                u || !c || e ? !c && u && e && (s = "below") : (s = "above"),
                ("above" == s || (e && "below" !== s)) &&
                  (h.top = r.top - a.height),
                null != s)
              ) {
                this.$dropdown
                  .removeClass(
                ...
                var d = this.$dropdown.find(".select2-search");
                "above" == s && d.is(":first-child")
                  ? d.detach().appendTo(this.$dropdown)
                  : "below" == s &&
                    d.is(":last-child") &&
                    d.detach().prependTo(this.$dropdown);
              }
          ...
          updateDropdownAdapter: function(t) {
            t.prototype.render = function() {
              ...
              this.options.get("multiple") &&
                (t =
                  '<div class="select2-buttons"><a href="#" class="select2-buttons-button select2-buttons-button-select-all">' +
                  s("select all") +
                  '</a> <a href="#" class="select2-buttons-button select2-buttons-button-deselect-all">' +
                  s("deselect all") +
                  "</a></div>");
              var e = n(
                  '<span class="select2-dropdown">' +
                    t +
                    '<span class="select2-results"></span></span>'
                ),
                i = this.$element;
              return (
                e
                  .find(".select2-buttons-button-select-all")
                  .on("click", function(t) {
                    t.preventDefault();
                    var e = [];
                    i.find("option").each(function() {
                ...
                e
                  .find(".select2-buttons-button-deselect-all")
                  .on("click", function(t) {
                    t.preventDefault(),
                      i.select2("val", ""),
                      i.select2("close");
          ...
          initSelect: function(t, e) {
            ...
            t.on("change", function(t) {}), t.select2(i);
          },
          initSelect2: function() {
            var t = this,
              e = n.fn.select2.amd.require("select2/dropdown/attachBody"),
              i = n.fn.select2.amd.require("select2/dropdown"),
              s = n.fn.select2.amd.require("select2/utils"),
              o = n.fn.select2.amd.require("select2/dropdown/search"),
              r = n.fn.select2.amd.require(
                "select2/dropdown/minimumResultsForSearch"
              ),
              a = n.fn.select2.amd.require("select2/dropdown/closeOnSelect");
            this.updateAttachBody(e),
              this.updateDropdownAdapter(i),
              (i = s.Decorate(i, o)),
              (i = s.Decorate(i, e)),
              (i = s.Decorate(i, r)),
              (i = s.Decorate(i, a)),
              ...
              n("select").trigger("select:init"),
              n(".inline-group").on("inline-group-row:added", function(t, e) {
      ...
      { "../utils/translate": 37, jquery: 69, select2: 71 }
    ],
    13: [
      function(t, e, i) {
        var n = t("jquery"),
        ...
        (s.prototype = {
          ...
          initApplicationPinning: function(t) {
            ...
            t.find(".pin-toggle").on("click", function(i) {
              ...
              var s = n(this).closest(".app-item"),
                o = s.data("app-label"),
                r = t.find("#toggle-application-pin-form");
              r.find('input[name="app_label"]').val(o), e.pinToggle(r, t, s);
            }),
          ...
          updateAppsHide: function(t) {
            var e = t.find(".apps-list"),
              i = t.find(".apps-list-pinned"),
              n = t.find(".apps-hide");
            (0 != e.children().length && 0 != i.children().length) ||
            !e.is(":visible")
              ? (n.toggleClass("apps-visible", e.is(":visible")),
                n.toggleClass("apps-hidden", !e.is(":visible")))
              : n.removeClass("apps-visible apps-hidden");
          },
          initAppsHide: function(t) {
            var e = this,
              i = t.find(".apps-list"),
              n = t.find(".apps-list-pinned"),
              s = t.find(".apps-hide");
            s.on("click", function(n) {
              n.preventDefault(),
                i.slideFadeToggle(200, "swing", function() {
                  (localStorage.side_menu_apps_list_visible = i.is(":visible")),
                    e.updateAppsHide(t);
                });
            }),
              "false" === localStorage.side_menu_apps_list_visible &&
                (0 != n.children().length
                  ? i.hide()
                  : (localStorage.side_menu_apps_list_visible = !0)),
              this.updateAppsHide(t);
          },
          run: function() {
            try {
      ...
      function(t, e, i) {
        ...
        (o.prototype = {
              ...
              success: function(t) {
                if (!t.error) {
                  ...
                  i
                    ...
                    .append(t.title),
                    i.find(".bookmarks-remove").data("bookmark-id", t.id),
                    e.append(i);
                }
              }
            });
          ...
          initBookmarksAdding: function(t) {
            var e = this,
              i = t.find("#bookmarks-add-form"),
              o = i.find('input[name="title"]'),
              r = i.find('input[name="url"]'),
              a = t.find("#bookmarks-add-dialog"),
              l = t.find(".bookmarks-list");
            t.find(".bookmarks-add").on("click", function(t) {
              t.preventDefault();
              var c = n(this),
                u = c.data("title") ? c.data("title") : document.title,
              ...
              (d[s("Add")] = function() {
                ...
                a.dialog({ resizable: !1, modal: !0, buttons: d });
            });
          },
          initBookmarksRemoving: function(t) {
            var e = this,
              i = t.find("#bookmarks-remove-form"),
              o = i.find('input[name="id"]'),
              r = t.find("#bookmarks-remove-dialog");
            t.on("click", ".bookmarks-remove", function(t) {
              t.preventDefault();
              var a = n(this),
                l = a.closest(".bookmark-item"),
                c = a.data("bookmark-id");
              o.val(c);
              var u = {};
              (u[s("Delete")] = function() {
    ...
    16: [
      function(t, e, i) {
        var n = t("jquery"),
          s = t("./application-pinning"),
          o = t("./bookmarks"),
          r = t("./popup"),
          a = t("perfect-scrollbar");
        t("browsernizr/test/touchevents"), t("browsernizr"), t("jquery.cookie");
        var l = function(t) {
          this.$sidebar = t;
        };
        (l.prototype = {
          initScrollBars: function(t) {
            if (!n(document.documentElement).hasClass("touchevents")) {
              new a(".sidebar-wrapper");
            }
          },
          initSideBarToggle: function() {
            ...
            n(".sidebar-toggle").on("click", t.bind(this)),
              n(document.body).on("click", ".sidebar-backdrop", t.bind(this));
          },
          sideBarToggle: function() {
            var t = n(".sidebar-dependent"),
              e =
                !t.hasClass("sidebar-opened") &&
                !n(document.body).hasClass("menu-pinned");
            n(document.body)
              .toggleClass("non-scrollable", e)
              .removeClass("menu-pinned"),
              t.toggleClass("sidebar-opened", e),
              this.storePinStatus(!1),
              this.toggleBackdrop(e);
          },
          toggleBackdrop: function(t) {
            if (t) {
              var e = n("<div/>", { class: "sidebar-backdrop" });
              n(document.body).append(e), e.animate({ opacity: 0.5 }, 300);
            } else
              n(".sidebar-backdrop").animate({ opacity: 0 }, 300, function() {
                n(this).remove();
              });
          },
              ...
              function() {
                ...
                n(document.body).hasClass("menu-pinned")
                  ? (t.removeClass("sidebar-opened"),
                    n(document.body).removeClass("menu-pinned"),
                    this.storePinStatus(!1))
                  : (this.storePinStatus(!0),
                    n(document.body)
                      .addClass("menu-pinned")
                      .removeClass("non-scrollable")),
          ...
          run: function() {
            var t = this.$sidebar;
            new s(t).run(), new o(t).run(), new r(t).run();
            try {
              this.initScrollBars(t),
                this.addToggleButton(),
                this.initSideBarToggle(),
                this.initPinSideBar(t);
            } catch (e) {
              console.error(e, e.stack);
            }
            t.addClass("initialized");
        ...
        (s.prototype = {
            ...
            this.resetPopupDisplayTimeout(),
              ...
              (this.popupDisplayTimeout = setTimeout(function() {
                ...
                if ((e.hide(), i.$currentSectionLink)) {
                  var s = e.filter(
                      "." + i.$currentSectionLink.data("popup-section-class")
                    ),
                    o = s.find(".sidebar-popup-search");
                  s.show(),
                    o
                      .val("")
                      .trigger("change")
                      .focus(),
                    (i.$currentSection = s),
                    i.resetCurrentSectionListItems(),
                    (i.$currentSectionListItem = null);
                }
                t.stop().fadeIn(200, "swing"),
                  n(document.body).addClass("non-scrollable");
              }, e));
          },
          closePopup: function(t, e) {
            ...
            this.resetPopupDisplayTimeout(),
              ...
              (this.popupDisplayTimeout = setTimeout(function() {
                (i.popupDisplayTimeout = null),
                  i.setCurrentSectionLink(null),
                  (i.$currentSection = null),
                  t.stop().fadeOut(200, "swing"),
                  n(document.documentElement).hasClass("touchevents") ||
                    n(document.body).removeClass("non-scrollable");
              }, e));
          },
          ...
          initSectionsDisplay: function(t) {
            var e = this,
              i = t.find(".sidebar-popup-container"),
              s = t.find(".sidebar-popup");
            t
              .find(".popup-section-link")
              .on("mouseenter", function() {
                n(document.documentElement).hasClass("touchevents") ||
                  e.onSectionLinkInteracted(i, n(this));
              })
              ...
              .on("click", function(t) {
                t.preventDefault(),
                  !n(document.documentElement).hasClass("touchevents") &&
                  n(this).attr("href")
                    ? (document.location = n(this).attr("href"))
                    : e.onSectionLinkInteracted(i, n(this));
              }),
          ...
          initSectionsSearch: function(t) {
            t.find(".sidebar-popup-section").each(function() {
              var t = n(this),
                e = t.find(".sidebar-popup-search"),
                i = t.find(".sidebar-popup-list-item");
              e.on("change keyup", function() {
                var t = n(this).val();
                i.hide()
                  .find('.sidebar-popup-list-item-link:icontains("' + t + '")')
          ...
          resetCurrentSectionListItems: function() {
            this.$currentSection
              .find(".sidebar-popup-list-item:visible")
              .removeClass("selected");
          },
          moveSectionListItemSelection: function(t) {
            if (
              (null != this.$currentSectionListItem &&
                (t
                  ? (this.$currentSectionListItem = this.$currentSectionListItem
                      .nextAll(":visible")
                      .first())
                  : (this.$currentSectionListItem = this.$currentSectionListItem
                      .prevAll(":visible")
                      .first())),
              null == this.$currentSectionListItem ||
                0 == this.$currentSectionListItem.length)
            ) {
              var e = this.$currentSection.find(
                ".sidebar-popup-list-item:visible"
              );
          ...
          initSectionKeyboardControls: function() {
            ...
            n(document).keydown(function(e) {
              if (null != t.$currentSectionLink) {
                if (38 == e.which) t.moveSectionListItemSelection(!1);
                else if (40 == e.which) t.moveSectionListItemSelection(!0);
                else {
          ...
          initSectionLists: function(t) {
            var e = this;
            t
              .find(".sidebar-popup-list-item-link")
              .on("mouseenter", function() {
                (e.$currentSectionListItem = n(this).closest(
                  ".sidebar-popup-list-item"
                )),
                  e.resetCurrentSectionListItems(),
                  e.$currentSectionListItem.addClass("selected");
              })
              .on("touchmove touchend", function(t) {
                var e = n(this);
                return "touchmove" == t.type
                  ? void e.data("element_swiped", !0)
                  : ("touchend" == t.type &&
                      !e.data("element_swiped") &&
                      e.attr("href") &&
                      (window.location = e.attr("href")),
                    void e.data("element_swiped", !1));
              }),
      ...
      function(t, e, i) {
        ...
        (s.prototype = {
          moveChooser: function(t) {
            t.detach()
              .insertAfter(n(".user-tools-welcome-msg"))
          ...
          initChooser: function(t) {
            ...
            e.on("click", function(t) {
              t.preventDefault();
              var i = n(this);
              n.cookie("JET_THEME", i.data("theme"), {
                expires: 365,
                path: "/"
              });
              var s = [
                  { url: i.data("base-stylesheet"), class: "base-stylesheet" },
                  {
                    url: i.data("select2-stylesheet"),
                    class: "select2-stylesheet"
                  },
                  {
                    url: i.data("jquery-ui-stylesheet"),
                    class: "jquery-ui-stylesheet"
                  }
                ],
                o = 0,
                r = function() {
                  ++o, o == s.length && n(document).trigger("theme:changed");
                };
              n.each(s, function() {
                n("<link>")
                  .attr("rel", "stylesheet")
    ...
    19: [
      function(t, e, i) {
        var n = t("jquery");
        t("jquery-ui/ui/core"),
          t("jquery-ui/ui/position"),
          t("jquery-ui/ui/widget"),
          t("jquery-ui/ui/tooltip"),
          t("browsernizr/test/touchevents"),
          t("browsernizr");
        var s = function() {};
        (s.prototype = {
          initTooltips: function() {
            n(document.documentElement).hasClass("touchevents") ||
              n("a[title], .tooltip[title]").tooltip({ track: !0 });
          },
          run: function() {
            try {
              this.initTooltips();
          ...
          initTouchMoveHandler: function() {
            n(document).on("touchmove", function(t) {
              for (var e = !0, i = n(t.target); i.length > 0; ) {
                ...
                if (i.hasClass("scrollable") || i.hasClass("ui-widget-overlay"))
                  break;
                i = i.parent();
              }
              e || t.preventDefault();
      ...
      function(t, e, i) {
        ...
        (s.prototype = {
          ...
          moveActions: function(t) {
            var e = this.$changelist.find(".paginator"),
              i = n("<div>").addClass("changelist-footer");
            i.insertAfter(e),
              t.detach(),
              e.detach(),
              i
        ...
        (o.prototype = {
          findTabs: function(t, e) {
            ...
            return (
              t.each(function(t) {
                var e = n(this),
                  o = e.find("> h2").first(),
                  r = 0 != o.length ? o.html() : s("General"),
                  a = "module_" + t;
                e.addClass(a), o.remove(), i.push({ className: a, title: r });
              }),
              e.each(function(t) {
                var e = n(this),
                  o = e
                    .find(
                      "> h2, > fieldset.module > h2, .tabular.inline-related > .module > h2"
                    )
                    .first(),
                  r = 0 != o.length ? o.html() : s("General"),
                  a = "inline_" + t;
          ...
          createTabs: function(t, e) {
            if (!(e.length < 2)) {
              ...
              n.each(e, function() {
                var t = this,
                  e = n("<li>").addClass("changeform-tabs-item"),
                  s = n("<a>")
                    .addClass("changeform-tabs-item-link")
                    .html(t.title)
                    .attr("href", "#/tab/" + t.className + "/");
                s.appendTo(e), e.appendTo(i);
              }),
    ...
    25: [
      function(t, e, i) {
        ...
        (s.prototype = {
          run: function() {
            try {
              0 != n(".delete-confirmation-marker").length &&
                n("body").addClass("delete-confirmation");
            } catch (t) {
              console.error(t, t.stack);
            }
          }
      ...
      function(t, e, i) {
        ...
        (s.prototype = {
          updateBooleanIcons: function() {
            n('img[src$="admin/img/icon-yes.gif"]')
              .add('img[src$="admin/img/icon-yes.svg"]')
              .after(n('<span class="icon-tick">')),
              n('img[src$="admin/img/icon-no.gif"]')
                .add('img[src$="admin/img/icon-no.svg"]')
                .after(n('<span class="icon-cross">')),
              n('img[src$="admin/img/icon-unknown.gif"]')
                .add('img[src$="admin/img/icon-unknown.svg"]')
                .after(n('<span class="icon-question">'));
          },
          run: function() {
            try {
        ...
        (s.prototype = {
          removeSpacesBetweenPages: function() {
            this.$paginator.contents().each(function() {
              if (3 == this.nodeType) {
                var t = n(this);
                ("A" != t.prev().prop("tagName") &&
                  "SPAN" != t.prev().prop("tagName")) ||
                  ("A" != t.next().prop("tagName") &&
                    "SPAN" != t.next().prop("tagName")) ||
                  ("..." == n.trim(t.text())
                    ? t.wrap(n("<span>").addClass("disabled"))
                    : "" == n.trim(t.text()) && t.remove());
              }
            });
          },
          wrapPages: function() {
            ...
            this.$paginator.contents().each(function() {
              var s = n(this),
                o =
                  ("A" == this.tagName && !s.hasClass("showall")) ||
                  "SPAN" == this.tagName;
              o && (t = !0),
                t && (o && !e ? (s.detach(), (i = i.add(s))) : (e = !0));
            }),
              this.$paginator.prepend(
                n("<span>")
                  .addClass("pages-wrapper")
                  .append(i)
              );
          },
          wrapTextNodes: function() {
            ...
            this.$paginator.contents().each(function() {
              var i = n(this),
                s =
                  ("A" == this.tagName && !i.hasClass("showall")) ||
                  "SPAN" == this.tagName;
              s
                ? (t = !0)
                : t &&
        ...
        (s.prototype = {
          ...
          updateLinkIcons: function() {
            this.replaceLinkIcon(
              ...
              n('img[src*="admin/img/selector-search"]').remove(),
              n(
      ...
      function(t, e, i) {
        ...
        (s.prototype = {
          updateObjectLinks: function() {
            var t = this.$inline.find(".inline_label"),
              e = t.find("> .inlinechangelink");
            t
              .find("+ a")
          ...
          updateOriginalCell: function() {
            this.$inline.find("tr").each(function() {
              ...
              t.contents().each(function() {
                var t = n(this);
                return 3 == t.get(0).nodeType
                  ? void t.remove()
                  : t.hasClass("inlinechangelink")
                  ? void 0
                  : (t.addClass("inlineviewlink"), !1);
              }),
                t.find("a").text(""),
                0 == t.children().length && t.parent().addClass("empty");
            });
          },
          run: function() {
            try {
      ...
      function(t, e, i) {
        ...
        (s.prototype = {
          getToolbar: function(t) {
            ...
            return (
              0 == e.length &&
                ((e = n("<div>").attr("id", "toolbar")),
                n("#changelist").prepend(e)),
              e
            );
          },
          ...
          moveFilters: function(t, e) {
            var i,
              s = e.find("#searchbar");
            t
              .find("#changelist-filter")
              .children()
              .each(function() {
                var t = n(this);
                if ("H3" == t.prop("tagName")) i = t.text();
                  ...
                  n.each(t.prop("attributes"), function() {
                    ...
                    o.addClass("changelist-filter-select"),
                    r.filter(".selected").length > 1 && o.attr("multiple", !0),
                    r.each(function(t) {
                      var e = n(this),
                        s = e.find("a"),
                        r = n("<option>")
                          .text(s.text())
                          .attr("data-url", s.attr("href"))
                          .attr("selected", e.hasClass("selected"));
                      if (0 == t) {
                        null != i && r.text(i);
                        var a = n("<option>")
                          .attr("disabled", !0)
                  ...
                  var a = n("<span>")
                    ...
                    .append(o);
                  s.length ? a.insertAfter(s) : e.append(a), (i = null);
                  ...
                  var l = t.find(".changelist-filter-popup-toggle"),
                    ...
                    a = n("<span>")
                      .addClass("changelist-filter-select-wrapper")
                      .append(t);
                  s.length ? a.insertAfter(s) : e.append(a),
          ...
          fixFloatLineBreak: function() {
            n("#content-main").each(function() {
              var t = n(this);
              n.each(
                ["#toolbar", ".object-tools", "changeform-navigation"],
                function(e, i) {
                  var s = t.find(i).first();
                  if (0 != s.length)
                    return (
                      n("<div>")
                        .addClass("clear")
      ...
      function(t, e, i) {
        ...
        (s.prototype = {
          updateUserTools: function(t) {
            var e = n("<ul>").addClass("sidebar-dependent"),
              i = t
                .find("strong")
                .first()
                .text();
    ...
    34: [
      function(t, e, i) {
        ...
        (jet = { jQuery: n }),
          t("./layout-updaters/actions"),
          t("./layout-updaters/breadcrumbs"),
          t("./layout-updaters/paginator"),
          t("./layout-updaters/toolbar"),
          t("./layout-updaters/object-tools"),
          t("./layout-updaters/user-tools"),
          t("./layout-updaters/changeform-tabs"),
          t("./layout-updaters/tabular-inline"),
          t("./layout-updaters/stacked-inline"),
          t("./layout-updaters/related-widget-wrapper"),
          t("./layout-updaters/delete-confirmation"),
          t("./layout-updaters/branding"),
          t("./layout-updaters/icons"),
          t("./features/sidebar/main"),
          t("./features/filters"),
          t("./features/changeform-tabs"),
          t("./features/checkboxes"),
          t("./features/date-time-widgets"),
          t("./features/inlines"),
          t("./features/changelist"),
          t("./features/tooltips"),
          t("./features/dashboard"),
          t("./features/changeform"),
          t("./features/themes"),
          t("./features/selects"),
          t("./features/siblings"),
          t("./features/related-popups"),
          t("./features/scroll-to-bottom-detector"),
          t("./features/touchmove-non-scrollable");
      },
      {
    ...
    37: [
      function(t, e, i) {
        e.exports = function(t) {
          return void 0 == window.django ? t : django.gettext(t);
        };
      },
      {}
    ],
    38: [
      function(t, e, i) {
        ...
        (s.prototype = {
          push: function(t) {
            t.top[this.name][t.top[this.name].length - 1] != t &&
              t.top[this.name].push(t);
          },
          pop: function() {
            window.top[this.name].pop();
          },
          previous: function() {
            return void 0 == window.top[this.name] ||
              !n.isArray(window.top[this.name]) ||
              window.top[this.name].length < 2
              ? null
              : window.top[this.name][window.top[this.name].length - 2];
          }
        }),
          (e.exports = s);
      },
    ...
    39: [
      function(t, e, i) {
        var n = t("./lib/Modernizr"),
          s = t("./lib/ModernizrProto"),
          o = t("./lib/classes"),
          r = t("./lib/testRunner"),
          a = t("./lib/setClasses");
        r(), a(o), delete s.addTest, delete s.addAsyncTest;
    ...
    40: [
      function(t, e, i) {
        var n = t("./ModernizrProto.js"),
          s = function() {};
        (s.prototype = n), (s = new s()), (e.exports = s);
      },
    ...
    45: [
      function(t, e, i) {
        function n() {
          var t = document.body;
          return t || ((t = s(o ? "svg" : "body")), (t.fake = !0)), t;
        }
        var s = t("./createElement.js"),
          o = t("./isSVG.js");
        e.exports = n;
      },
    ...
    46: [
      function(t, e, i) {
        function n(t, e, i, n) {
          ...
          if (parseInt(i, 10))
            for (; i--; )
              (c = o("div")), (c.id = n ? n[i] : h + (i + 1)), d.appendChild(c);
          return (
            (a = o("style")),
            (a.type = "text/css"),
            (a.id = "s" + h),
        ...
        var s = (t("./ModernizrProto.js"), t("./docElement.js")),
          o = t("./createElement.js"),
          r = t("./getBody.js");
        e.exports = n;
      },
      {
    ...
    48: [
      function(t, e, i) {
        var n = t("./docElement.js"),
          s = "svg" === n.nodeName.toLowerCase();
        e.exports = s;
      },
      { "./docElement.js": 44 }
    ],
    49: [
      function(t, e, i) {
        var n = t("./ModernizrProto.js"),
          s = n._config.usePrefixes
            ? " -webkit- -moz- -o- -ms- ".split(" ")
            : ["", ""];
        (n._prefixes = s), (e.exports = s);
      },
      { "./ModernizrProto.js": 41 }
    ],
    50: [
      function(t, e, i) {
        function n(t) {
          ...
          if ((r && (e = e.baseVal), s._config.enableJSClass)) {
            var n = new RegExp("(^|\\s)" + i + "no-js(\\s|$)");
            e = e.replace(n, "$1" + i + "js$2");
          }
          s._config.enableClasses &&
            ((e += " " + i + t.join(" " + i)),
            r ? (o.className.baseVal = e) : (o.className = e));
        }
        var s = t("./Modernizr.js"),
          o = t("./docElement.js"),
          r = t("./isSVG.js");
        e.exports = n;
      },
        ...
        function n() {
          ...
          for (var h in s)
            if (s.hasOwnProperty(h)) {
              ...
              for (
                n = a(e.fn, "function") ? e.fn() : e.fn, l = 0;
                l < t.length;
                l++
              )
                (c = t[l]),
                  ...
                  1 === u.length
                    ? (o[u[0]] = n)
                    : (!o[u[0]] ||
                        o[u[0]] instanceof Boolean ||
                        (o[u[0]] = new Boolean(o[u[0]])),
                      (o[u[0]][u[1]] = n)),
                  r.push((n ? "" : "no-") + u.join("-"));
            }
        }
    ...
    52: [
      function(t, e, i) {
        var n = t("./ModernizrProto.js"),
          s = t("./injectElementWithStyles.js"),
          o = (n.testStyles = s);
        e.exports = o;
      },
    ...
    54: [
      function(t, e, i) {
        var n = t("./../lib/Modernizr.js"),
          s = t("./../lib/prefixes.js"),
          o = t("./../lib/testStyles.js");
              ...
              _resetButton: function() {
                ...
                s.primary || s.secondary
                  ? (this.options.text &&
                    ...
                    this.options.text ||
                      (r.push(
                        o ? "ui-button-icons-only" : "ui-button-icon-only"
                      ),
                  ...
                  return (
                    t.each(s, function() {
                      (i -= parseFloat(t.css(e, "padding" + this)) || 0),
                        n &&
                          (i -=
                            parseFloat(t.css(e, "border" + this + "Width")) ||
                            0),
            ...
            t.extend(i.prototype, {
                    ...
                    (i.trigger = t(
                      this._get(i, "buttonImageOnly")
                        ...
                        : t("<button type='button'></button>")
                            ...
                            .html(
                              o
                                ? t("<img/>").attr({ src: o, alt: s, title: s })
                                : s
                            )
                    )),
              ...
              _dialogDatepicker: function(e, i, n, s, r) {
                ...
                return (
                  ...
                  o(d.settings, s || {}),
                  (i =
                    i && i.constructor === Date ? this._formatDate(d, i) : i),
              ...
              parseDate: function(e, i, n) {
                ...
                if (
                  ((i = "object" == typeof i ? i.toString() : i + ""), "" === i)
                )
                  return null;
                var s,
                  o,
                      ...
                      switch (c[2] || "d") {
                        ...
                        case "M":
                          (r += parseInt(c[1], 10)),
                            (a = Math.min(
                              a,
                              t.datepicker._getDaysInMonth(o, r)
                            ));
                          break;
                        case "y":
                        case "Y":
              ...
              _generateHTML: function(t) {
                ...
                for (
                  t.drawMonth = J,
                    ...
                    a = this._get(t, "gotoCurrent") && t.currentDay ? G : W,
                  ...
                  for (x = "", this.maxRows = 4, C = 0; C < X[1]; C++) {
                    if (
                      ...
                      if (((S += "<div class='ui-datepicker-group"), X[1] > 1))
                        switch (C) {
                          case 0:
                    ...
                    for (
                      S +=
                        ...
                        T +
                        "'>" +
                        (/all|left/.test(T) && 0 === k ? (R ? o : n) : "") +
                        (/all|right/.test(T) && 0 === k ? (R ? n : o) : "") +
                    ...
                    for (
                      S += I + "</tr></thead><tbody>",
                        ...
                        N = (this._getFirstDayOfMonth(tt, J) - u + 7) % 7,
                        A = Math.ceil((N + E) / 7),
                        j = V && this.maxRows > A ? this.maxRows : A,
                        this.maxRows = j,
                        $ = this._daylightSavingAdjust(new Date(tt, J, 1 - N)),
                        M = 0;
                      M < j;
                      M++
                    ) {
            ...
            (t.ui.intersect = (function() {
              ...
              return function(e, i, n, s) {
                ...
                var o =
                    ...
                    e.margins.left,
                  r =
                    (e.positionAbs || e.position.absolute).top + e.margins.top,
                        ...
                        a &&
                          (this.options.greedy &&
                            ...
                            (o = this.element
                              ...
                              .filter(function() {
                                return (
                                  t(this).droppable("instance").options
                                    .scope === s
                                );
                              })),
                            o.length &&
                ...
                (t.fn.position = function(s) {
                  ...
                  return (
                    ...
                    this.each(function() {
                      ...
                      "right" === s.my[0]
                        ? (S.left -= h)
                        : "center" === s.my[0] && (S.left -= h / 2),
                        "bottom" === s.my[1]
                          ? (S.top -= d)
                          : "center" === s.my[1] && (S.top -= d / 2),
                        (S.left += I[0]),
                        (S.top += I[1]),
                          ...
                          (c = function(t) {
                            var e = v.left - S.left,
                              ...
                              l = {
                                ...
                                vertical:
                                  o < 0 ? "top" : n > 0 ? "bottom" : "middle"
                              };
                            m < h && a(e + i) < m && (l.horizontal = "center"),
                              g < d && a(n + o) < g && (l.vertical = "middle"),
                              r(a(e), a(i)) > r(a(n), a(o))
              ...
              _mouseStop: function(e) {
                ...
                return (
                  this._helper &&
                    ...
                    c.animate ||
                      this.element.css(t.extend(r, { top: l, left: a })),
            ...
            _getItemsAsjQuery: function(e) {
              ...
              if (c && e)
                for (n = c.length - 1; n >= 0; n--)
                  for (
                    o = t(c[n], this.document[0]), s = o.length - 1;
                    s >= 0;
                    s--
                  )
            ...
            _refreshItems: function(e) {
              ...
              if (d && this.ready)
                for (i = d.length - 1; i >= 0; i--)
                  for (
                    s = t(d[i], this.document[0]), n = s.length - 1;
                    n >= 0;
                    n--
                  )
              ...
              for (i = h.length - 1; i >= 0; i--)
                for (r = h[i][1], a = h[i][0], n = 0, c = a.length; n < c; n++)
                  (l = t(a[n])),
          ...
          return (
            ...
            (t.Widget.prototype = {
              ...
              option: function(e, i) {
                ...
                if ("string" == typeof e)
                  if (
                    ((r = {}), (n = e.split(".")), (e = n.shift()), n.length)
                  ) {
                    for (
        ...
        !(function(e) {
          ...
          (a.defaults = {}),
            (t.removeCookie = function(e, i) {
              return (
                void 0 !== t.cookie(e) &&
                (t.cookie(e, "", t.extend({}, i, { expires: -1 })),
                !t.cookie(e))
              );
            });
        });
        ...
        !(function(t) {
          ...
          function e(e) {
            ...
            if (
              ...
              "wheelDeltaX" in r && (u = r.wheelDeltaX * -1),
              "axis" in r &&
                r.axis === r.HORIZONTAL_AXIS &&
                ((u = h * -1), (h = 0)),
              (c = 0 === h ? u : h),
              "deltaY" in r && ((h = r.deltaY * -1), (c = h)),
              "deltaX" in r && ((u = r.deltaX), 0 === h && (c = u * -1)),
              0 !== h || 0 !== u)
            ) {
              if (1 === r.deltaMode) {
              ...
              return (
                (d = Math.max(Math.abs(h), Math.abs(u))),
                (!o || d < o) && ((o = d), n(r, d) && (o /= 40)),
                n(r, d) && ((c /= 40), (u /= 40), (h /= 40)),
      ...
      function(t, e, i) {
        !(function(t, i) {
          ...
          function o(t) {
            var e = (_t[t] = {});
            return (
              st.each(t.match(bt) || [], function(t, i) {
                e[i] = !0;
              }),
              e
            );
          ...
          function r() {
            ft.addEventListener
              ...
              : (ft.detachEvent("onreadystatechange", a),
          ...
          function g(t, e) {
            ...
            return void 0 === e || (e && st.nodeName(t, e))
              ? st.merge([t], o)
              : o;
          }
          function v(t) {
          ...
          function b(t) {
            return (
              (t.type = (null !== st.find.attr(t, "type")) + "/" + t.type), t
            );
          }
          function _(t) {
          ...
          function C(e, i) {
            var n,
              ...
              o =
                ...
                (n = t.getDefaultComputedStyle(s[0]))
                  ? n.display
                  : st.css(s[0], "display");
            return s.detach(), o;
          }
                ...
                n.style &&
                  ...
                  e
                    ? (o[r] || "none" !== i || (n.style.display = ""),
                      "" === n.style.display &&
                        It(n) &&
                        (o[r] = st._data(n, "olddisplay", D(n.nodeName))))
                    : ((s = It(n)),
                      ((i && "none" !== i) || !s) &&
                        st._data(
                          n,
                          "olddisplay",
                          s ? i : st.css(n, "display")
                        )));
            for (r = 0; r < a; r++)
              (n = t[r]),
                n.style &&
          ...
          function E(t, e, i, n, s) {
            for (
              var o =
                  i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0,
                r = 0;
              o < 4;
              o += 2
            )
              "margin" === i && (r += st.css(t, i + St[o], !0, s)),
                n
                  ? ("content" === i &&
                      (r -= st.css(t, "padding" + St[o], !0, s)),
                    "margin" !== i &&
                      (r -= st.css(t, "border" + St[o] + "Width", !0, s)))
                  : ((r += st.css(t, "padding" + St[o], !0, s)),
                    "padding" !== i &&
                      (r += st.css(t, "border" + St[o] + "Width", !0, s)));
            return r;
          ...
          function N(t, e, i) {
            var n = !0,
              ...
              o = te(t),
              r =
                it.boxSizing && "border-box" === st.css(t, "boxSizing", !1, o);
            if (s <= 0 || null == s) {
              if (
                ((s = ee(t, e, o)),
                (s < 0 || null == s) && (s = t.style[e]),
                ne.test(s))
              )
                return s;
          ...
          function M(t, e, i) {
            for (
              var n, s = (be[e] || []).concat(be["*"]), o = 0, r = s.length;
              o < r;
              o++
            )
          ...
          function H(t, e, i) {
            ...
            i.queue ||
              ...
              1 === t.nodeType &&
                ...
                (u =
                  "none" === c
                    ? st._data(t, "olddisplay") || D(t.nodeName)
                    : c),
                "inline" === u &&
                  "none" === st.css(t, "float") &&
                  (it.inlineBlockNeedsLayout && "inline" !== D(t.nodeName)
                    ? (p.zoom = 1)
          ...
          function Y(t, e, i, n) {
            ...
            if (st.isArray(e))
              st.each(e, function(e, s) {
                i || Ue.test(t)
                  ? n(t, s)
                  : Y(t + "[" + ("object" == typeof s ? e : "") + "]", s, i, n);
              });
            else if (i || "object" !== st.type(e)) n(t, e);
            else for (s in e) Y(t + "[" + s + "]", e[s], i, n);
          }
          function B() {
            try {
              ...
              each: function(t, e, n) {
                ...
                if (n) {
                  if (a)
                    ...
                    for (o in t) if (((s = e.apply(t[o], n)), s === !1)) break;
                } else if (a)
          ...
          var ct = (function(t) {
            ...
            function g(t, e, i, n, s) {
              for (
                var o, r = [], a = 0, l = t.length, c = null != e;
                a < l;
                a++
              )
                (o = t[a]) &&
            ...
            function y(t) {
              for (
                ...
                if ((i = k.relative[t[a].type])) u = [p(f(u), i)];
                  ...
                  if (
                    ((i = k.filter[t[a].type].apply(null, t[a].matches)), i[O])
                  ) {
            ...
            try {
              Z.apply((V = J.call(q.childNodes)), q.childNodes),
            ...
            (w = e.support = {}),
              ...
              (N = e.setDocument = function(t) {
                ...
                return n !== A && 9 === n.nodeType && n.documentElement
                  ? ((A = n),
                    ...
                    (w.getElementsByClassName = vt.test(
                      n.getElementsByClassName
                    )),
                    (w.getById = s(function(t) {
                      return (
                        (j.appendChild(t).id = O),
                          ...
                          return i
                            ...
                            : ((i =
                              ...
                              (!w.sortDetached &&
                                ...
                                ? t === n || (t.ownerDocument === q && z(q, t))
                                  ? -1
                                  : e === n ||
                                    (e.ownerDocument === q && z(q, e))
                                  ? 1
                                  : P
                                  ? tt(P, t) - tt(P, e)
                                  : 0
              ...
              (e.attr = function(t, e) {
                ...
                var i = k.attrHandle[e.toLowerCase()],
                  n =
                    i && K.call(k.attrHandle, e.toLowerCase())
                      ? i(t, e, !$)
                      : void 0;
                return void 0 !== n
                  ? n
                    ...
                    return 1 === n && 0 === s
                      ...
                      : function(e, i, l) {
                          ...
                          if (g) {
                            ...
                            if (
                              ((f = [r ? g.firstChild : g.lastChild]), r && y)
                            ) {
                              for (
                                u = g[O] || (g[O] = {}),
                                  c = u[t] || [],
              ...
              (S = e.select = function(t, e, i, n) {
                ...
                if (((i = i || []), 1 === h.length)) {
                  if (
                    ...
                    if (
                      ((e = (k.find.ID(r.matches[0].replace(wt, kt), e) ||
                        [])[0]),
                      !e)
                    )
                      return i;
          ...
          st.extend({
            ...
            st.fn.extend({
              ...
              add: function(t, e) {
                return this.pushStack(
                  st.unique(st.merge(this.get(), st(t, e)))
                );
              },
              addBack: function(t) {
                return this.add(
          ...
          (st.Callbacks = function(t) {
            ...
            var e,
              ...
              u = function(o) {
                ...
                (e = !1),
                  l &&
                    (c ? c.length && u(c.shift()) : i ? (l = []) : h.disable());
              },
              h = {
                add: function() {
                  if (l) {
          ...
          !(function() {
            ...
            if (
              ...
              (it.html5Clone =
                "<:nav></:nav>" !==
                ft.createElement("nav").cloneNode(!0).outerHTML),
              (t.type = "checkbox"),
              (t.checked = !0),
              i.appendChild(t),
          ...
          (st.event = {
            ...
            remove: function(t, e, i, n, s) {
              ...
              if (g && (u = g.events)) {
                ...
                st.isEmptyObject(u) &&
                  (delete g.handle, st._removeData(t, "events"));
              }
            },
              ...
              (st.event.special.change = {
                setup: function() {
                  return Nt.test(this.nodeName)
                    ? (("checkbox" !== this.type && "radio" !== this.type) ||
                        (st.event.add(this, "propertychange._change", function(
                          t
                        ) {
                ...
                teardown: function() {
                  return (
                    st.event.remove(this, "._change"), !Nt.test(this.nodeName)
                  );
                }
              }),
            it.focusinBubbles ||
          ...
          (Vt.optgroup = Vt.option),
                    ...
                    if ("object" === st.type(o))
                      ...
                      if (
                        (!it.leadingWhitespace &&
                          Ot.test(o) &&
                          p.push(e.createTextNode(Ot.exec(o)[0])),
                        !it.tbody)
                      )
                        for (
                          o =
            ...
            st.fn.extend({
              ...
              empty: function() {
                for (var t, e = 0; null != (t = this[e]); e++) {
                  for (
                    1 === t.nodeType && st.cleanData(g(t, !1));
                    t.firstChild;

                  )
                    t.removeChild(t.firstChild);
                  t.options &&
                    st.nodeName(t, "select") &&
                    (t.options.length = 0);
                }
                return this;
              },
              ...
              html: function(t) {
                return Pt(
                  ...
                  function(t) {
                    ...
                    if (void 0 === t)
                      return 1 === e.nodeType
                        ? e.innerHTML.replace(Lt, "")
                        : void 0;
                    if (
                      "string" == typeof t &&
                      !Yt.test(t) &&
                      (it.htmlSerialize || !zt.test(t)) &&
                      (it.leadingWhitespace || !Ot.test(t)) &&
                      !Vt[(Wt.exec(t) || ["", ""])[1].toLowerCase()]
                    ) {
                      t = t.replace(qt, "<$1></$2>");
                      try {
                        for (; i < n; i++)
              ...
              domManip: function(t, e) {
                ...
                if (
                  ...
                  for (o = st.map(g(a, "script"), b), s = o.length; l < c; l++)
                    (n = a),
                      l !== h &&
                        ((n = st.clone(n, !0, !0)),
                        s && st.merge(o, g(n, "script"))),
                      e.call(this[l], n, l);
                  if (s)
                    for (
            ...
            st.each(
              ...
              function(t, e) {
                st.fn[t] = function(t) {
                  for (
                    var i, n = 0, s = [], o = st(t), r = o.length - 1;
                    n <= r;
                    n++
                  )
                ...
                i && i.style
                  ? ((e = ft.createElement("div")),
                    ...
                    typeof e.style.zoom !== xt &&
                      ...
                      (e.appendChild(ft.createElement("div")).style.width =
                        "5px"),
                      (t = 3 !== e.offsetWidth)),
                    i.removeChild(n),
                    t)
                ...
                (i = ft.getElementsByTagName("body")[0]),
                  i &&
                    ...
                    t.getComputedStyle &&
                      ...
                      (r =
                        "4px" ===
                        (t.getComputedStyle(e, null) || { width: "4px" })
                          .width),
          ...
          st.extend({
            ...
            style: function(t, e, i, n) {
              if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var s,
                  ...
                  l = t.style;
                if (
                  ((e = st.cssProps[a] || (st.cssProps[a] = S(l, a))),
            ...
            css: function(t, e, i, n) {
              var s,
                ...
                a = st.camelCase(e);
              return (
                (e = st.cssProps[a] || (st.cssProps[a] = S(t.style, a))),
                (r = st.cssHooks[e] || st.cssHooks[a]),
            ...
            st.each(["height", "width"], function(t, e) {
              st.cssHooks[e] = {
                get: function(t, i, n) {
                  if (i)
                    return ae.test(st.css(t, "display")) && 0 === t.offsetWidth
            ...
            (st.cssHooks.marginRight = T(it.reliableMarginRight, function(
              t,
              e
            ) {
              if (e)
                return st.swap(t, { display: "inline-block" }, ee, [
                  t,
                  "marginRight"
                ]);
            })),
            st.each({ margin: "", padding: "", border: "Width" }, function(
              t,
              e
            ) {
              (st.cssHooks[t + e] = {
          ...
          (st.Animation = st.extend(z, {
            tweener: function(t, e) {
              ...
              for (var i, n = 0, s = t.length; n < s; n++)
                (i = t[n]), (be[i] = be[i] || []), be[i].unshift(e);
            },
          ...
          st.fn.extend({
                ...
                s = this[0];
              {
                ...
                if (s)
                  return (
                    (e =
                      st.valHooks[s.type] ||
                      st.valHooks[s.nodeName.toLowerCase()]),
                ...
                select: {
                  ...
                  set: function(t, e) {
                    for (
                      ...
                      if (
                        ((n = s[r]),
                        st.inArray(st.valHooks.option.get(n), o) >= 0)
                      )
                        try {
                          n.selected = i = !0;
                        } catch (a) {
            ...
            st.each(["radio", "checkbox"], function() {
              (st.valHooks[this] = {
                set: function(t, e) {
                  if (st.isArray(e))
                    return (t.checked = st.inArray(st(t).val(), e) >= 0);
                }
              }),
                it.checkOn ||
          ...
          st.fn.extend({
                ...
                if (t && 3 !== o && 8 !== o && 2 !== o)
                  return typeof t.getAttribute === xt
                    ...
                    : ((1 === o && st.isXMLDoc(t)) ||
                        ...
                        (n =
                          st.attrHooks[e] ||
                          (st.expr.match.bool.test(e) ? ke : we))),
                      void 0 === i
              ...
              set: function(t, e, i) {
                return (
                  e === !1
                    ? st.removeAttr(t, i)
                    : (Te && De) || !Ce.test(i)
                    ? t.setAttribute((!De && st.propFix[i]) || i, i)
            ...
            st.each(st.expr.match.bool.source.match(/\w+/g), function(t, e) {
              ...
              xe[e] =
                (Te && De) || !Ce.test(e)
                  ...
                  : function(t, e, i) {
                      if (!i)
                        return t[st.camelCase("default-" + e)]
                          ? e.toLowerCase()
                          : null;
                    };
            }),
            ...
            De ||
              ((we = {
                set: function(t, e, i) {
                  ...
                  if (
                    (n ||
                      t.setAttributeNode(
                        (n = t.ownerDocument.createAttribute(i))
                      ),
                    (n.value = e += ""),
              ...
              (xe.id = xe.name = xe.coords = function(t, e, i) {
                var n;
                if (!i)
                  return (n = t.getAttributeNode(e)) && "" !== n.value
                    ? n.value
                    : null;
              }),
              (st.valHooks.button = {
              ...
              propHooks: {
                tabIndex: {
                  get: function(t) {
                    ...
                    return e
                      ? parseInt(e, 10)
                      : Se.test(t.nodeName) || (Ie.test(t.nodeName) && t.href)
                      ? 0
                      : -1;
                  }
                }
          ...
          st.fn.extend({
            ...
            toggleClass: function(t, e) {
              ...
              return "boolean" == typeof e && "string" === i
                ...
                : this.each(function() {
                    if ("string" === i)
                      for (
                        var e, n = 0, s = st(this), o = t.match(bt) || [];
                        (e = o[n++]);
            ...
            hasClass: function(t) {
              for (var e = " " + t + " ", i = 0, n = this.length; i < n; i++)
                if (
                  1 === this[i].nodeType &&
                  (" " + this[i].className + " ").replace(Pe, " ").indexOf(e) >=
                    0
                )
                  return !0;
              return !1;
          ...
          (je = We.exec($e.toLowerCase()) || []),
              ...
              ajax: function(t, e) {
                function i(t, e, i, n) {
                  ...
                  2 !== b &&
                    ...
                    (w.statusText = (e || k) + ""),
                    s
                      ? f.resolveWith(d, [u, k, w])
                      : f.rejectWith(d, [w, k, v]),
                    w.statusCode(g),
                    (g = void 0),
                    l &&
                      p.trigger(s ? "ajaxSuccess" : "ajaxError", [
                        w,
                        h,
                        s ? u : v
                      ]),
                ...
                if (
                  ...
                  (h.dataTypes = st
                    ...
                    .match(bt) || [""]),
                  null == h.crossDomain &&
                    ((n = We.exec(h.url.toLowerCase())),
                    (h.crossDomain = !(
                      !n ||
                      (n[1] === je[1] &&
                        n[2] === je[2] &&
                        (n[3] || ("http:" === n[1] ? "80" : "443")) ===
                          (je[3] || ("http:" === je[1] ? "80" : "443")))
                    ))),
                  h.data &&
                    h.processData &&
            ...
            st.fn.extend({
              wrapAll: function(t) {
                ...
                if (this[0]) {
                  var e = st(t, this[0].ownerDocument)
                    .eq(0)
                    .clone(!0);
            ...
            (st.expr.filters.hidden = function(t) {
              return (
                ...
                (!it.reliableHiddenOffsets() &&
                  "none" ===
                    ((t.style && t.style.display) || st.css(t, "display")))
              );
            }),
          ...
          (st.param = function(t, e) {
            ...
            if (
              (void 0 === e &&
                (e = st.ajaxSettings && st.ajaxSettings.traditional),
              st.isArray(t) || (t.jquery && !st.isPlainObject(t)))
            )
              st.each(t, function() {
                s(this.name, this.value);
              });
            else for (i in t) Y(i, t[i], e, s);
          ...
          (st.fn.load = function(t, e, i) {
            ...
            return (
              a >= 0 &&
                ((n = st.trim(t.slice(a, t.length))), (t = t.slice(0, a))),
              st.isFunction(e)
                ? ((i = e), (e = void 0))
              ...
              offset: function(t) {
                ...
                if (o)
                  return (
                    (e = o.documentElement),
                    st.contains(e, s)
                      ? (typeof s.getBoundingClientRect !== xt &&
      ...
      function(t, e, i) {
        ...
        function c(t, e) {
          var i = t.element.classList,
            n = I.state.scrolling(e);
          i.contains(n) ? clearTimeout(P[e]) : i.add(n);
        }
        function u(t, e) {
          P[e] = setTimeout(function() {
            return (
              t.isAlive && t.element.classList.remove(I.state.scrolling(e))
            );
        ...
        function f(t, e, i, n, s) {
          ...
          var p = t.element;
          (t.reach[l] = null),
            p[a] < 1 && (t.reach[l] = "start"),
            p[a] > t[o] - t[r] - 1 && (t.reach[l] = "end"),
            e &&
              (p.dispatchEvent(d("ps-scroll-" + l)),
              e < 0
                ? p.dispatchEvent(d("ps-scroll-" + c))
                : e > 0 && p.dispatchEvent(d("ps-scroll-" + u)),
              n && h(t, l)),
            t.reach[l] &&
              (e || s) &&
              p.dispatchEvent(d("ps-" + l + "-reach-" + t.reach[l]));
        }
        function m(t) {
          return parseInt(t, 10) || 0;
        }
        ...
        function y(t) {
          ...
          (t.containerWidth = Math.round(n.width)),
            ...
            e.contains(t.scrollbarXRail) ||
              (l(e, I.element.rail("x")).forEach(function(t) {
                return a(t);
              }),
              e.appendChild(t.scrollbarXRail)),
            e.contains(t.scrollbarYRail) ||
              (l(e, I.element.rail("y")).forEach(function(t) {
                return a(t);
              }),
            ...
            _(e, t),
            t.scrollbarXActive
              ? e.classList.add(I.state.active("x"))
              : (e.classList.remove(I.state.active("x")),
                (t.scrollbarXWidth = 0),
                (t.scrollbarXLeft = 0),
                (e.scrollLeft = t.isRtl === !0 ? t.contentWidth : 0)),
            t.scrollbarYActive
              ? e.classList.add(I.state.active("y"))
              : (e.classList.remove(I.state.active("y")),
        ...
        function x(t, e) {
          ...
          function n() {
            u(t, f),
              t[m].classList.remove(I.state.clicking),
            ...
            (v = g[p]),
              ...
              s
                ...
                : (t.event.bind(t.ownerDocument, "mousemove", i),
                  ...
                  e.preventDefault()),
              t[m].classList.add(I.state.clicking),
              e.stopPropagation();
          }
          var o = e[0],
            r = e[1],
            ...
            b = null,
            _ = null;
          t.event.bind(t[h], "mousedown", function(t) {
            s(t);
          }),
            t.event.bind(t[h], "touchstart", function(t) {
              s(t, !0);
            });
        }
        function C(t) {
          function e(e, n) {
            ...
            if (0 === n) {
              ...
              if (
                (0 === o && e < 0) ||
                (o >= t.contentWidth - t.containerWidth && e > 0)
              )
                return !t.settings.wheelPropagation;
            }
            return !0;
        ...
        function D(t) {
          function e(e, i) {
            var n,
              s = Math.floor(r.scrollTop),
              o = 0 === r.scrollTop,
              a = s + r.offsetHeight === r.scrollHeight,
              l = 0 === r.scrollLeft,
              c = r.scrollLeft + r.offsetWidth === r.scrollWidth;
            return (
              (n = Math.abs(i) > Math.abs(e) ? o || a : l || c),
              !n || !t.settings.wheelPropagation
            );
          }
          function i(t) {
            var e = t.deltaX,
              i = -1 * t.deltaY;
            return (
              ("undefined" != typeof e && "undefined" != typeof i) ||
          ...
          function s(t, e, i) {
            if (!j.isWebKit && r.querySelector("select:focus")) return !0;
            if (!r.contains(t)) return !1;
            for (var s = t; s && s !== r; ) {
              if (s.classList.contains(I.element.consuming)) return !0;
              var o = n(s);
              if (i && o.overflowY.match(/(scroll|auto)/)) {
                var a = s.scrollHeight - s.clientHeight;
                if (
                  a > 0 &&
                  ((s.scrollTop > 0 && i < 0) || (s.scrollTop < a && i > 0))
                )
                  return !0;
              }
              if (e && o.overflowX.match(/(scroll|auto)/)) {
                ...
                if (
                  l > 0 &&
                  ((s.scrollLeft > 0 && e < 0) || (s.scrollLeft < l && e > 0))
                )
                  return !0;
              }
              s = s.parentNode;
            ...
            if (!s(n.target, a, l)) {
              ...
              t.settings.useBothWheelAxes
                ? t.scrollbarYActive && !t.scrollbarXActive
                  ? (l
                      ? (r.scrollTop -= l * t.settings.wheelSpeed)
                  ...
                  : t.scrollbarXActive &&
                    ...
                    (a
                      ...
                      : (r.scrollLeft -= l * t.settings.wheelSpeed),
                    (c = !0))
                : ((r.scrollTop -= l * t.settings.wheelSpeed),
                  (r.scrollLeft += a * t.settings.wheelSpeed)),
                y(t),
                (c = c || e(a, l)),
                c && !n.ctrlKey && (n.stopPropagation(), n.preventDefault());
            }
          }
          var r = t.element;
          "undefined" != typeof window.onwheel
            ? t.event.bind(r, "wheel", o)
            : "undefined" != typeof window.onmousewheel &&
              t.event.bind(r, "mousewheel", o);
        }
        function T(t) {
          function e(e, i) {
            ...
            if (r > o) {
              if (
                ...
                return 0 === window.scrollY && i > 0 && j.isChrome;
            } else if (
              o > r &&
              ((e < 0 && s === t.contentWidth - t.containerWidth) ||
                (e > 0 && 0 === s))
            )
              return !0;
            return !0;
          ...
          function i(e, i) {
            (u.scrollTop -= i), (u.scrollLeft -= e), y(t);
          }
          function s(t) {
          ...
          function a(t, e, i) {
            ...
            for (var s = t; s && s !== u; ) {
              ...
              if (i && o.overflowY.match(/(scroll|auto)/)) {
                ...
                if (
                  r > 0 &&
                  ((s.scrollTop > 0 && i < 0) || (s.scrollTop < r && i > 0))
                )
                  return !0;
              }
              if (e && o.overflowX.match(/(scroll|auto)/)) {
                ...
                if (
                  a > 0 &&
                  ((s.scrollLeft > 0 && e < 0) || (s.scrollLeft < a && e > 0))
                )
                  return !0;
              }
              s = s.parentNode;
          ...
          function l(t) {
            if (o(t)) {
              ...
              var u = new Date().getTime(),
                f = u - d;
              f > 0 && ((p.x = l / f), (p.y = c / f), (d = u)),
                e(l, c) && t.preventDefault();
            }
          }
          function c() {
              ...
              (f = setInterval(function() {
                return t.isInitialized
                  ...
                  ? Math.abs(p.x) < 0.01 && Math.abs(p.y) < 0.01
                    ? void clearInterval(f)
                    : t.element
                    ? (i(30 * p.x, 30 * p.y), (p.x *= 0.8), void (p.y *= 0.8))
                    : void clearInterval(f)
                  : void clearInterval(f);
              }, 10)));
          }
          if (j.supportsTouch || j.supportsIePointer) {
            var u = t.element,
              h = {},
              d = 0,
              p = {},
        ...
        (A.prototype.eventElement = function(t) {
          var e = this.eventElements.filter(function(e) {
            return e.element === t;
          })[0];
          return e || ((e = new E(t)), this.eventElements.push(e)), e;
        }),
          (A.prototype.bind = function(t, e, i) {
            this.eventElement(t).bind(e, i);
          }),
          (A.prototype.unbind = function(t, e, i) {
        ...
        var j = {
          ...
          H = function(t, e) {
            ...
            (this.element = t), t.classList.add(I.main), (this.settings = $());
            for (var r in e) this.settings[r] = e[r];
            (this.containerWidth = null),
              (this.containerHeight = null),
              (this.contentWidth = null),
              (this.contentHeight = null);
            var a = function() {
                return t.classList.add(I.state.focus);
              },
              l = function() {
                return t.classList.remove(I.state.focus);
              };
            (this.isRtl = "rtl" === n(t).direction),
              this.isRtl === !0 && t.classList.add(I.rtl),
              ...
              (this.scrollbarXRail = o(I.element.rail("x"))),
              t.appendChild(this.scrollbarXRail),
              (this.scrollbarX = o(I.element.thumb("x"))),
            ...
            (this.scrollbarXBottom = parseInt(c.bottom, 10)),
              isNaN(this.scrollbarXBottom)
                ? ((this.isScrollbarXUsingBottom = !1),
                  (this.scrollbarXTop = m(c.top)))
                : (this.isScrollbarXUsingBottom = !0),
              (this.railBorderXWidth =
                m(c.borderLeftWidth) + m(c.borderRightWidth)),
              s(this.scrollbarXRail, { display: "block" }),
              (this.railXMarginWidth = m(c.marginLeft) + m(c.marginRight)),
              s(this.scrollbarXRail, { display: "" }),
              (this.railXWidth = null),
              (this.railXRatio = null),
              (this.scrollbarYRail = o(I.element.rail("y"))),
              t.appendChild(this.scrollbarYRail),
              (this.scrollbarY = o(I.element.thumb("y"))),
            ...
            (this.scrollbarYRight = parseInt(u.right, 10)),
              isNaN(this.scrollbarYRight)
                ? ((this.isScrollbarYUsingRight = !1),
                  (this.scrollbarYLeft = m(u.left)))
                : (this.isScrollbarYUsingRight = !0),
              (this.scrollbarYOuterWidth = this.isRtl
                ? v(this.scrollbarY)
                : null),
              (this.railBorderYWidth =
                m(u.borderTopWidth) + m(u.borderBottomWidth)),
              s(this.scrollbarYRail, { display: "block" }),
              (this.railYMarginHeight = m(u.marginTop) + m(u.marginBottom)),
        ...
        (H.prototype.update = function() {
          this.isAlive &&
            ...
            (this.railXMarginWidth =
              m(n(this.scrollbarXRail).marginLeft) +
              m(n(this.scrollbarXRail).marginRight)),
            (this.railYMarginHeight =
              m(n(this.scrollbarYRail).marginTop) +
              m(n(this.scrollbarYRail).marginBottom)),
          ...
          var e = (function() {
              ...
              return (
                    ...
                    !(function(e) {
                      ...
                      (f = function(t, e) {
                        ...
                        (d = function(t, i, n, o) {
                          ...
                          if (
                            ...
                            for (
                              ...
                              if (
                                ((d = f(i[p], o)), (u = d.f), "require" === u)
                              )
                                _[p] = m.require(t);
                              else if ("exports" === u)
                                (_[p] = m.exports(t)), (y = !0);
                              else if ("module" === u) a = _[p] = m.module(t);
                              else if (s(g, u) || s(v, u) || s(b, u))
                                _[p] = c(u);
                              else {
                                if (!d.p) throw new Error(t + " missing " + u);
                                d.p.load(d.n, r(o, !0), l(u), {}),
                                  (_[p] = g[u]);
                              }
                            (h = n ? n.apply(g[t], _) : void 0),
                              t &&
                                (a && a.exports !== e && a.exports !== g[t]
                                  ? (g[t] = a.exports)
                                  : (h === e && y) || (g[t] = h));
                          } else t && (g[t] = n);
                        }),
                        (t = i = p = function(t, i, n, s, o) {
                          if ("string" == typeof t)
                            return m[t] ? m[t](i) : c(f(t, i).f);
                          if (!t.splice) {
                            if (((y = t), y.deps && p(y.deps, y.callback), !i))
                              return;
                            i.splice ? ((t = i), (i = n), (n = null)) : (t = e);
                          }
                          return (
                            (i = i || function() {}),
                            "function" == typeof n && ((n = s), (s = o)),
                            s
                              ? d(e, t, i, n)
                              : setTimeout(function() {
                                  d(e, t, i, n);
                      ...
                      for (
                        var c = function(t) {
                            ...
                            return function() {
                              ...
                              return (
                                t.call(arguments, e), s.apply(this, arguments)
                              );
                            };
                          },
                          u = 0;
                      ...
                      for (var e in t) {
                        ...
                        if (1 !== i.length) {
                          for (var s = 0; s < i.length; s++) {
                            var o = i[s];
                            (o =
                              o.substring(0, 1).toLowerCase() + o.substring(1)),
                              o in n || (n[o] = {}),
                  ...
                  return (
                    ...
                    (i.prototype.setClasses = function() {
                      ...
                      this.data.current(function(i) {
                        ...
                        s.each(function() {
                          ...
                          (null == i.element && t.inArray(s, n) > -1)
                    ...
                    (i.prototype.showLoading = function(t) {
                      ...
                      var e = this.options.get("translations").get("searching"),
                        i = { disabled: !0, loading: !0, text: e(t) },
                        n = this.option(i);
                    ...
                    (i.prototype.option = function(e) {
                      ...
                      e.disabled &&
                        ...
                        null != e._resultId && (i.id = e._resultId),
                      ...
                      this.$results.attr("id", s),
                        ...
                        e.on("results:next", function() {
                          ...
                          if (!(s >= e.length)) {
                            ...
                            o.trigger("mouseenter");
                            var r =
                                n.$results.offset().top +
                                n.$results.outerHeight(!1),
                              a = o.offset().top + o.outerHeight(!1),
                              l = n.$results.scrollTop() + a - r;
                            0 === s
                              ? n.$results.scrollTop(0)
                              : a > r && n.$results.scrollTop(l);
                          }
                        }),
                        ...
                        this.$results.on(
                          ...
                          function(e) {
                            ...
                            return "true" === i.attr("aria-selected")
                              ? void (n.options.get("multiple")
                                  ? n.trigger("unselect", {
                                      originalEvent: e,
                                      data: s
                                    })
                                  : n.trigger("close"))
                              : void n.trigger("select", {
                                  originalEvent: e,
                                  data: s
                                });
                          }
                  ...
                  function(t, e) {
                    ...
                    return (
                      ...
                      (i.prototype._handleKeyboardClear = function(t, i, n) {
                        n.isOpen() ||
                          (i.which != e.DELETE && i.which != e.BACKSPACE) ||
                          this._handleClear(i);
                      }),
                  ...
                  function(t, e, i) {
                    ...
                    return (
                      ...
                      (n.prototype.bind = function(t, e, n) {
                        ...
                        t.call(this, e, n),
                          e.on("open", function() {
                            s.$search.attr("tabindex", 0), s.$search.focus();
                          }),
                          e.on("close", function() {
                ...
                e.define(
                  ...
                  function(t, e, i) {
                    function n(e, i) {
                      (this.ajaxOptions = this._applyDefaults(i.get("ajax"))),
                        null != this.ajaxOptions.processResults &&
                          (this.processResults = this.ajaxOptions.processResults),
                        t.__super__.constructor.call(this, e, i);
                    }
                    return (
                      e.Extend(n, t),
                          ...
                          var n = o.transport(
                            ...
                            function(n) {
                              ...
                              s.options.get("debug") &&
                                window.console &&
                                console.error &&
                                ((o && o.results && i.isArray(o.results)) ||
                                  console.error(
                      ...
                      function n(t, o) {
                        for (var r = t.results, a = 0; a < r.length; a++) {
                          var l = r[a],
                            c =
                              null != l.children &&
                              !n({ results: l.children }, !0),
                            u = l.text === e.term;
                          if (u || c) return !o && ((t.data = r), void i(t));
                        }
                        if (o) return !0;
                        var h = s.createTag(e);
                        if (null != h) {
                  ...
                  return (
                    (t.prototype.query = function(t, e, i) {
                      ...
                      this.current(function(s) {
                        ...
                        return n.maximumSelectionLength > 0 &&
                          o >= n.maximumSelectionLength
                  ...
                  function() {
                    ...
                    return (
                      (e.prototype.showSearch = function(e, i) {
                        return (
                          !(t(i.data.results) < this.minimumResultsForSearch) &&
                          e.call(this, i)
                        );
                      }),
                      e
                ...
                e.define("select2/dropdown/selectOnClose", [], function() {
                  ...
                  return (
                    ...
                    (t.prototype._handleSelectOnClose = function() {
                      var t = this.getHighlightedResults();
                      t.length < 1 ||
                        this.trigger("select", { data: t.data("data") });
                    }),
                    t
                  );
                }),
                  ...
                  function(
                    ...
                    (P.prototype.apply = function(h) {
                      if (
                        ...
                        if (
                          ...
                          h.minimumInputLength > 0 &&
                            (h.dataAdapter = c.Decorate(h.dataAdapter, v)),
                          h.maximumInputLength > 0 &&
                            (h.dataAdapter = c.Decorate(h.dataAdapter, y)),
                          h.maximumSelectionLength > 0 &&
                            (h.dataAdapter = c.Decorate(h.dataAdapter, b)),
                          h.tags &&
                            (h.dataAdapter = c.Decorate(h.dataAdapter, m)),
                          (null == h.tokenSeparators && null == h.tokenizer) ||
                            (h.dataAdapter = c.Decorate(h.dataAdapter, g)),
                          null != h.query)
                        ) {
                          var I = e(h.amdBase + "compat/query");
                          h.dataAdapter = c.Decorate(h.dataAdapter, I);
                        }
                        if (null != h.initSelection) {
                          var P = e(h.amdBase + "compat/initSelection");
                          h.dataAdapter = c.Decorate(h.dataAdapter, P);
                        }
                      }
                      if (
                      ...
                      if (null == h.selectionAdapter) {
                        if (
                          (h.multiple
                            ? (h.selectionAdapter = s)
                            : (h.selectionAdapter = n),
                          null != h.placeholder &&
                          ...
                          var A = e(h.amdBase + "compat/containerCss");
                          h.selectionAdapter = c.Decorate(
                            h.selectionAdapter,
                            A
                          );
                      ...
                      if (t.isArray(h.language)) {
                        var M = new u();
                        h.language.push("en");
                        for (var H = h.language, L = 0; L < H.length; L++) {
                          var z = H[L],
                            O = {};
                          try {
                            O = u.loadPath(z);
          ...
          $.extend(Timepicker.prototype, {
            ...
            _attachTimepicker: function(target, settings) {
              ...
              (inst.settings = $.extend(
                ...
                "input" == nodeName
                  ...
                  : inline && this._inlineTimepicker(target, inst);
            },
              ...
              (e.append = $([])),
                ...
                i.hasClass(this.markerClassName) ||
                  ...
                  i
                    ...
                    .keydown(this._doKeyDown)
                    .keyup(this._doKeyUp)
                    .bind("setData.timepicker", function(t, i, n) {
                      e.settings[i] = n;
                    })
            ...
            _doKeyDown: function(t) {
              var e = $.timepicker._getInst(t.target),
                i = !0;
              if (((e._keyEvent = !0), $.timepicker._timepickerShowing))
                switch (t.keyCode) {
                  case 9:
                  ...
                  case 13:
                    return (
                      $.timepicker._updateSelectedValue(e),
            ...
            _doKeyUp: function(t) {
              var e = $.timepicker._getInst(t.target);
              $.timepicker._setTimeFromField(e),
            ...
            _attachments: function(t, e) {
              ...
              e.append && e.append.remove(),
                ...
                t.unbind("focus.timepicker", this._showTimepicker),
                t.unbind("click.timepicker", this._adjustZIndex),
                e.trigger && e.trigger.remove();
              var s = this._get(e, "showOn");
              if (
                (("focus" != s && "both" != s) ||
                  (t.bind("focus.timepicker", this._showTimepicker),
                  t.bind("click.timepicker", this._adjustZIndex)),
                "button" == s || "both" == s)
              ) {
                var o = this._get(e, "button");
                null == o &&
                  ((o = $(
                    '<button class="ui-timepicker-trigger" type="button">...</button>'
                  )),
                  t.after(o)),
                  $(o).bind("click.timepicker", function() {
                    return (
                      $.timepicker._timepickerShowing &&
                      $.timepicker._lastInput == t[0]
                        ? $.timepicker._hideTimepicker()
                        : e.input.is(":disabled") ||
                          $.timepicker._showTimepicker(t[0]),
                      !1
                    );
                  });
              }
            ...
            _inlineTimepicker: function(t, e) {
              ...
              i.hasClass(this.markerClassName) ||
                ...
                $.data(t, PROP_NAME, e),
                this._setTimeFromField(e),
                this._updateTimepicker(e),
                e.tpDiv.show());
            },
            ...
            _showTimepicker: function(t) {
              if (
                ...
                !$.timepicker._isDisabledTimepicker(t) &&
                  $.timepicker._lastInput != t)
              ) {
                $.timepicker._hideTimepicker();
                var e = $.timepicker._getInst(t);
                $.timepicker._curInst &&
                  $.timepicker._curInst != e &&
                ...
                extendRemove(e.settings, i ? i.apply(t, [t, e]) : {}),
                  ...
                  ($.timepicker._lastInput = t),
                  $.timepicker._setTimeFromField(e),
                  $.timepicker._inDialog && (t.value = ""),
                  $.timepicker._pos ||
                    (($.timepicker._pos = $.timepicker._findPos(t)),
                    ($.timepicker._pos[1] += t.offsetHeight));
                var n = !1;
                $(t)
                  .parents()
                  .each(function() {
                ...
                if (
                  ...
                  $.timepicker._updateTimepicker(e),
                  !e.inline && "object" == typeof $.ui.position)
                ) {
                  e.tpDiv.position({
                    of: e.input,
                  ...
                  var s = e.tpDiv.offset();
                  $.timepicker._pos = [s.top, s.left];
                }
                if (
                  ((e._hoursClicked = !1),
                  (e._minutesClicked = !1),
                  (s = $.timepicker._checkOffset(e, s, n)),
                  e.tpDiv.css({
                    position:
                  ...
                  var o = $.timepicker._get(e, "showAnim"),
                    r = $.timepicker._get(e, "duration"),
                    a = function() {
                  ...
                  $.timepicker._adjustZIndex(t),
                    $.effects && $.effects[o]
                      ? e.tpDiv.show(
                          o,
                          $.timepicker._get(e, "showOptions"),
                          r,
                          a
                        )
                      : e.tpDiv.show(o ? r : null, a),
                    (o && r) || a(),
                    e.input.is(":visible") &&
                      !e.input.is(":disabled") &&
                      e.input.focus(),
            ...
            _getZIndex: function(t) {
              for (var e, i, n = $(t), s = 0; n.length && n[0] !== document; )
                (e = n.css("position")),
                  ("absolute" !== e && "relative" !== e && "fixed" !== e) ||
            ...
            _updateTimepicker: function(t) {
              t.tpDiv.empty().append(this._generateHTML(t)),
                this._rebindDialogEvents(t);
            },
              ...
              t.tpDiv
                ...
                .bind("mouseout", function() {
                  $(this).removeClass("ui-state-hover"),
                    this.className.indexOf("ui-timepicker-prev") != -1 &&
                      $(this).removeClass("ui-timepicker-prev-hover"),
                    this.className.indexOf("ui-timepicker-next") != -1 &&
                      $(this).removeClass("ui-timepicker-next-hover");
                })
                .bind("mouseover", function() {
                  i._isDisabledTimepicker(
                    t.inline ? t.tpDiv.parent()[0] : t.input[0]
                  ) ||
                    ($(this)
            ...
            _generateHTML: function(t) {
              var e,
                ...
                n,
                s,
                o = 1 == this._get(t, "showPeriod"),
                r = 1 == this._get(t, "showPeriodLabels"),
                a = 1 == this._get(t, "showLeadingZero"),
                l = 1 == this._get(t, "showHours"),
                c = 1 == this._get(t, "showMinutes"),
                u = this._get(t, "amPmText"),
                h = this._get(t, "rows"),
                d = 0,
                p = 0,
                f = 0,
                ...
                _ = null,
                w = 0,
                k = this._get(t, "hourText"),
                x = this._get(t, "showCloseButton"),
                C = this._get(t, "closeButtonText"),
                D = this._get(t, "showNowButton"),
                T = this._get(t, "nowButtonText"),
                S = this._get(t, "showDeselectButton"),
                I = this._get(t, "deselectButtonText"),
                P = x || D || S;
              for (e = b.starts; e <= b.ends; e++) y.push(e);
              if (((_ = Math.ceil(y.length / h)), r)) {
                for (w = 0; w < y.length; w++) y[w] < 12 ? f++ : m++;
                (w = 0),
                  (d = Math.floor((f / y.length) * h)),
                  (p = Math.floor((m / y.length) * h)),
                  h != d + p &&
                    (f && (!m || !d || (p && f / d >= m / p)) ? d++ : p++),
                  (g = Math.min(d, 1)),
                  (v = d + 1),
              ...
              if (
                ...
                for (
                  s +=
                    '<td class="ui-timepicker-hours"><div class="ui-timepicker-title ui-widget-header ui-helper-clearfix ui-corner-all">' +
                    k +
                    '</div><table class="ui-timepicker">',
                    i = 1;
                  i <= h;
                  i++
                ) {
                  for (
                    ...
                    r && i < v && y[w] >= 12
                      ? (s += this._generateHTMLHourCell(t, void 0, o, a))
                      : ((s += this._generateHTMLHourCell(t, y[w], o, a)), w++);
                  s += "</tr>";
                }
                s += "</table></td>";
              }
              if (
                (c &&
                  ((s += '<td class="ui-timepicker-minutes">'),
                  (s += this._generateHTMLMinutes(t)),
                  (s += "</td>")),
                (s += "</tr>"),
                P)
              ) {
                ...
                D &&
                  (E +=
                    '<button type="button" class="ui-timepicker-now ui-state-default ui-corner-all"  data-timepicker-instance-id="#' +
                    t.id.replace(/\\\\/g, "\\") +
                    '" >' +
                    T +
                    "</button>"),
                  S &&
                    (E +=
                      '<button type="button" class="ui-timepicker-deselect ui-state-default ui-corner-all"  data-timepicker-instance-id="#' +
                      t.id.replace(/\\\\/g, "\\") +
                      '" >' +
                      I +
                      "</button>"),
                  x &&
                    (E +=
                      '<button type="button" class="ui-timepicker-close ui-state-default ui-corner-all"  data-timepicker-instance-id="#' +
                      t.id.replace(/\\\\/g, "\\") +
                      '" >' +
                      C +
                      "</button>"),
            ...
            _updateMinuteDisplay: function(t) {
              ...
              t.tpDiv.find("td.ui-timepicker-minutes").html(e),
                this._rebindDialogEvents(t);
            },
            _generateHTMLMinutes: function(t) {
              var e,
                ...
                o = this._get(t, "rows"),
                r = Array(),
                a = this._get(t, "minutes"),
                l = null,
                c = 0,
                u = 1 == this._get(t, "showMinutesLeadingZero"),
                h = this._get(t, "onMinuteShow"),
                d = this._get(t, "minuteText");
              for (
                a.starts || (a.starts = 0),
                  a.ends || (a.ends = 59),
                  a.manual || (a.manual = []),
              ...
              if (
                ...
                (l = Math.round(r.length / o + 0.49)),
                h &&
                  0 ==
                    h.apply(t.input ? t.input[0] : null, [t.hours, t.minutes]))
              )
                for (c = 0; c < r.length; c += 1)
                  if (
                    ((e = r[c]),
                    h.apply(t.input ? t.input[0] : null, [t.hours, e]))
                  ) {
                    t.minutes = e;
                    break;
                  }
              for (
                ...
                for (s += "<tr>"; c < n * l; ) {
                  var e = r[c],
                    f = "";
                  void 0 !== e &&
                    (f = e < 10 && u ? "0" + e.toString() : e.toString()),
                    (s += this._generateHTMLMinuteCell(t, e, f)),
                    c++;
                }
                s += "</tr>";
              }
            ...
            _generateHTMLHourCell: function(t, e, i, n) {
              ...
              var o = "",
                r = !0,
                a = this._get(t, "onHourShow"),
                l = this._get(t, "maxTime"),
                c = this._get(t, "minTime");
              return void 0 == e
                ? (o =
                    '<td><span class="ui-state-default ui-state-disabled">&nbsp;</span></td>')
                : (a && (r = a.apply(t.input ? t.input[0] : null, [e])),
                  r &&
                    (!isNaN(parseInt(l.hour)) && e > l.hour && (r = !1),
                    !isNaN(parseInt(c.hour)) && e < c.hour && (r = !1)),
                  (o = r
                    ? '<td class="ui-timepicker-hour-cell" data-timepicker-instance-id="#' +
                      ...
                      e.toString() +
                      '"><a class="ui-state-default ' +
                      (e == t.hours ? "ui-state-active" : "") +
                      '">' +
                      s.toString() +
                      "</a></td>"
                    : '<td><span class="ui-state-default ui-state-disabled ' +
                      (e == t.hours ? " ui-state-active " : " ") +
                      '">' +
                      s.toString() +
                      "</span></td>"));
            ...
            _generateHTMLMinuteCell: function(t, e, i) {
              var n = "",
                s = !0,
                o = t.hours,
                r = this._get(t, "onMinuteShow"),
                a = this._get(t, "maxTime"),
                l = this._get(t, "minTime");
              return (
                r && (s = r.apply(t.input ? t.input[0] : null, [t.hours, e])),
                void 0 == e
                  ? (n =
                      '<td><span class="ui-state-default ui-state-disabled">&nbsp;</span></td>')
                  : (s &&
                      null !== o &&
                      (!isNaN(parseInt(a.hour)) &&
                        !isNaN(parseInt(a.minute)) &&
                        o >= a.hour &&
                        e > a.minute &&
                        (s = !1),
                      !isNaN(parseInt(l.hour)) &&
                        !isNaN(parseInt(l.minute)) &&
                        o <= l.hour &&
                        e < l.minute &&
                        (s = !1)),
                    (n = s
            ...
            _enableTimepicker: function(t) {
              ...
              if (e.hasClass(this.markerClassName)) {
                ...
                if ("input" == s) {
                  t.disabled = !1;
                  var o = this._get(n, "button");
                  ($(o).removeClass("ui-state-disabled").disabled = !1),
                    n.trigger
                      .filter("button")
                      .each(function() {
                        this.disabled = !1;
            ...
            _disableTimepicker: function(t) {
              ...
              if (e.hasClass(this.markerClassName)) {
                var n = t.nodeName.toLowerCase();
                if ("input" == n) {
                  var s = this._get(i, "button");
                  ($(s).addClass("ui-state-disabled").disabled = !0),
                    (t.disabled = !0),
                    i.trigger
                      .filter("button")
                      .each(function() {
                ...
                (this._disabledInputs = $.map(this._disabledInputs, function(
                  ...
                  (this._disabledInputs[this._disabledInputs.length] = e.attr(
                    "id"
                  ));
              }
            },
            ...
            _checkOffset: function(t, e, i) {
              var n = t.tpDiv.outerWidth(),
                s = t.tpDiv.outerHeight(),
              ...
              return (
                ...
                (e.left -= Math.min(
                  e.left,
                  e.left + n > a && a > n ? Math.abs(e.left + n - a) : 0
                )),
                (e.top -= Math.min(
                  e.top,
                  e.top + s > l && l > s ? Math.abs(s + r) : 0
                )),
                e
              );
            },
            ...
            _checkExternalClick: function(t) {
              if ($.timepicker._curInst) {
                var e = $(t.target);
                e[0].id == $.timepicker._mainDivId ||
                  0 != e.parents("#" + $.timepicker._mainDivId).length ||
                  e.hasClass($.timepicker.markerClassName) ||
                  e.hasClass($.timepicker._triggerClass) ||
                  !$.timepicker._timepickerShowing ||
                  ($.timepicker._inDialog && $.blockUI) ||
                  $.timepicker._hideTimepicker();
              }
            ...
            _hideTimepicker: function(t) {
              ...
              if (
                ...
                $.effects && $.effects[i]
                  ? e.tpDiv.hide(i, $.timepicker._get(e, "showOptions"), n, s)
                  : e.tpDiv[
                      "slideDown" == i
                        ? "slideUp"
                        : "fadeIn" == i
                  ...
                  this._inDialog &&
                    ...
                    $.blockUI && ($.unblockUI(), $("body").append(this.tpDiv))),
                  (this._inDialog = !1);
            ...
            _setTimeFromField: function(t) {
              if (t.input.val() != t.lastVal) {
                var e = this._get(t, "defaultTime"),
                  i = "now" == e ? this._getCurrentTimeRounded(t) : e;
                if (
                  (0 == t.inline && "" != t.input.val() && (i = t.input.val()),
                  i instanceof Date)
                )
                  (t.hours = i.getHours()), (t.minutes = i.getMinutes());
                else {
                  var n = (t.lastVal = i);
                  if ("" == i) (t.hours = -1), (t.minutes = -1);
                  else {
                    var s = this.parseTime(t, n);
                    (t.hours = s.hours), (t.minutes = s.minutes);
                  }
                }
            ...
            _optionTimepicker: function(t, e, i) {
              ...
              "string" == typeof e && ((s = {}), (s[e] = i)),
                n &&
                  ...
                  this._curInst == n &&
                    (this._hideTimepicker(), this._updateTimepicker(n)),
                  n.inline && this._updateTimepicker(n));
            },
            _setTimeTimepicker: function(t, e) {
              var i = this._getInst(t);
              i &&
                (this._setTime(i, e),
                this._updateTimepicker(i),
                this._updateAlternate(i, e));
            },
            _setTime: function(t, e, i) {
              var n = t.hours,
                s = t.minutes;
              if (e instanceof Date)
                (t.hours = e.getHours()), (t.minutes = e.getMinutes());
              else {
                var e = this.parseTime(t, e);
                (t.hours = e.hours), (t.minutes = e.minutes);
              }
              (n == t.hours && s == t.minutes) ||
                i ||
                t.input.trigger("change"),
                this._updateTimepicker(t),
                this._updateSelectedValue(t);
            },
            _getCurrentTimeRounded: function(t) {
              var e = new Date(),
                i = e.getMinutes(),
                n = this._get(t, "minutes"),
                s = Math.round(i / n.interval) * n.interval;
              return e.setMinutes(s), e;
            },
            parseTime: function(t, e) {
              var i = new Object();
              if (((i.hours = -1), (i.minutes = -1), !e)) return "";
              var n = this._get(t, "timeSeparator"),
                s = this._get(t, "amPmText"),
                o = this._get(t, "showHours"),
                r = this._get(t, "showMinutes"),
                a = this._get(t, "optionalMinutes"),
                l = 1 == this._get(t, "showPeriod"),
                c = e.indexOf(n);
              if (
                (c != -1
                  ? ((i.hours = parseInt(e.substr(0, c), 10)),
                    (i.minutes = parseInt(e.substr(c + 1), 10)))
                  : !o || (r && !a)
                  ? !o && r && (i.minutes = parseInt(e, 10))
                  : (i.hours = parseInt(e, 10)),
                o)
              ) {
                var u = e.toUpperCase();
                i.hours < 12 &&
                  l &&
                  u.indexOf(s[1].toUpperCase()) != -1 &&
                  (i.hours += 12),
                  12 == i.hours &&
                    l &&
                    u.indexOf(s[0].toUpperCase()) != -1 &&
                    (i.hours = 0);
              }
              return i;
            },
            selectNow: function(t) {
              var e = $(t.target).attr("data-timepicker-instance-id"),
                i = $(e),
                n = this._getInst(i[0]),
                s = new Date();
              (n.hours = s.getHours()),
                (n.minutes = s.getMinutes()),
                this._updateSelectedValue(n),
                this._updateTimepicker(n),
            ...
            selectHours: function(t) {
              var e = $(t.currentTarget),
                i = e.attr("data-timepicker-instance-id"),
                n = parseInt(e.attr("data-hour")),
                s = t.data.fromDoubleClick,
                o = $(i),
                r = this._getInst(o[0]),
                a = 1 == this._get(r, "showMinutes");
              if ($.timepicker._isDisabledTimepicker(o.attr("id"))) return !1;
              e
                .parents(".ui-timepicker-hours:first")
                .find("a")
                .removeClass("ui-state-active"),
                e.children("a").addClass("ui-state-active"),
                (r.hours = n);
              var l = this._get(r, "onMinuteShow"),
                c = this._get(r, "maxTime"),
                u = this._get(r, "minTime");
              return (
                (!l &&
                  isNaN(parseInt(c.minute)) &&
                  isNaN(parseInt(u.minute))) ||
                  this._updateMinuteDisplay(r),
                this._updateSelectedValue(r),
                (r._hoursClicked = !0),
                (r._minutesClicked || s || 0 == a) &&
                  $.timepicker._hideTimepicker(),
                !1
              );
            },
            selectMinutes: function(t) {
              var e = $(t.currentTarget),
                i = e.attr("data-timepicker-instance-id"),
                n = parseInt(e.attr("data-minute")),
                s = t.data.fromDoubleClick,
                o = $(i),
                r = this._getInst(o[0]),
                a = 1 == this._get(r, "showHours");
              return (
                !$.timepicker._isDisabledTimepicker(o.attr("id")) &&
                (e
                  .parents(".ui-timepicker-minutes:first")
                  .find("a")
                  .removeClass("ui-state-active"),
                e.children("a").addClass("ui-state-active"),
                (r.minutes = n),
                this._updateSelectedValue(r),
                (r._minutesClicked = !0),
                !(!r._hoursClicked && !s && 0 != a) &&
                  ($.timepicker._hideTimepicker(), !1))
              );
            },
            _updateSelectedValue: function(t) {
              ...
              return (
                i && i.apply(t.input ? t.input[0] : null, [e, t]),
                this._updateAlternate(t, e),
                e
              );
            },
            _getParsedTime: function(t) {
              if (t.hours == -1 && t.minutes == -1) return "";
              (t.hours < t.hours.starts || t.hours > t.hours.ends) &&
                (t.hours = 0),
                (t.minutes < t.minutes.starts || t.minutes > t.minutes.ends) &&
                  (t.minutes = 0);
              var e = "",
                i = 1 == this._get(t, "showPeriod"),
                n = 1 == this._get(t, "showLeadingZero"),
                s = 1 == this._get(t, "showHours"),
                o = 1 == this._get(t, "showMinutes"),
                r = 1 == this._get(t, "optionalMinutes"),
                a = this._get(t, "amPmText"),
                l = t.hours ? t.hours : 0,
                c = t.minutes ? t.minutes : 0,
                u = l ? l : 0,
                h = "";
              u == -1 && (u = 0),
                c == -1 && (c = 0),
              ...
              return (
                ...
                !s ||
                  !o ||
                  (r && 0 == p) ||
                  (h += this._get(t, "timeSeparator")),
                !o || (r && 0 == p) || (h += p),
                s && e.length > 0 && (h += this._get(t, "periodSeparator") + e),
                h
              );
            },
            ...
            _getTimeAsDateTimepicker: function(t) {
              var e = this._getInst(t);
              return e.hours == -1 && e.minutes == -1
                ? ""
                : ((e.hours < e.hours.starts || e.hours > e.hours.ends) &&
                    (e.hours = 0),
                  (e.minutes < e.minutes.starts ||
                    e.minutes > e.minutes.ends) &&
                    (e.minutes = 0),
                  new Date(0, 0, 0, e.hours, e.minutes, 0));
            },
            ...
            ($.fn.timepicker = function(t) {
              $.timepicker.initialized ||
                ($(document).mousedown($.timepicker._checkExternalClick),
                ($.timepicker.initialized = !0)),
                0 === $("#" + $.timepicker._mainDivId).length &&
              ...
              return "string" != typeof t ||
                ...
                ? "option" == t &&
                  2 == arguments.length &&
                  "string" == typeof arguments[1]
                  ? $.timepicker["_" + t + "Timepicker"].apply(
                      $.timepicker,
                      [this[0]].concat(e)
                    )
                  : this.each(function() {
                      "string" == typeof t
                        ...
                        : $.timepicker._attachTimepicker(this, t);
                    })
                : $.timepicker["_" + t + "Timepicker"].apply(
                    $.timepicker,
                    [this[0]].concat(e)
