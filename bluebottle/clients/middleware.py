...
class TenantProperties(local):
    """
        A tenant propery file is read from the
        MULTI_TENANT_DIR/<tenant_name>/properties.py
        It can contain arbitrary python expressions and a reference to
    ...
    def __getattr__(self, k):
        """
            Search (in that specific order) tenant properties and settings. Raise
