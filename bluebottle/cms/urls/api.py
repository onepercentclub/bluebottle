...
from bluebottle.cms.views import (
    ResultPageDetail, HomePageDetail, NewsItemDetail, OldPageDetail, PageDetail, BlockDetail, HomeDetail
)
...
urlpatterns = [
    ...
    url(r'^home$', HomeDetail.as_view(), {'pk': 1}, name='home-content-detail'),
