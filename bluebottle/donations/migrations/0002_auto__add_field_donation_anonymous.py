...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Donation.anonymous'
        db.add_column(u'donations_donation', 'anonymous',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Donation.anonymous'
        db.delete_column(u'donations_donation', 'anonymous')
