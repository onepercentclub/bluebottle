...
class TestEventAdmin(BluebottleAdminTestCase):
    ...
    def test_delete_participant_event_admin(self):
        ...
        data = {
            ...
            'contributors-0-contributor_ptr': self.participants[0].contributor_ptr_id,
            'contributors-0-activity': self.event.id,
            'contributors-0-user': self.participants[0].user_id,
            'contributors-0-time_spent': self.participants[0].time_spent,
            'contributors-0-DELETE': 'on',
            'contributors-1-contributor_ptr': self.participants[1].contributor_ptr_id,
            'contributors-1-activity': self.event.id,
            'contributors-1-user': self.participants[1].user_id,
            'contributors-1-time_spent': self.participants[1].time_spent,
            'contributors-2-contributor_ptr': self.participants[2].contributor_ptr_id,
            'contributors-2-activity': self.event.id,
            'contributors-2-user': self.participants[2].user_id,
            'contributors-2-time_spent': self.participants[2].time_spent,
