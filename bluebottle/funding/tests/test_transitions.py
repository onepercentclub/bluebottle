...
class FundingTestCase(BluebottleAdminTestCase):
    ...
    def test_default_status(self):
        ...
        organizer = self.funding.intentions.instance_of(Organizer).get()
    ...
    def test_review(self):
        ...
        organizer = funding.intentions.instance_of(Organizer).get()
    ...
    def test_new_funding_for_running_initiative(self):
        ...
        organizer = new_funding.intentions.first()
