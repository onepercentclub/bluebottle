...
class Migration(DataMigration):
    def forwards(self, orm):
        ...
        for ct in orm['contenttypes.contenttype'].objects.filter(
                app_label='fundraisers'):
            if ct.name == 'fund raiser':
                ct.name = 'fundraiser'
                ct.save()
    ...
    models = {
        ...
        u'fundraisers.fundraiser': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [],
                      {'to': u"orm['test.TestBaseUser']"}),
            'project': ('django.db.models.fields.related.ForeignKey', [],
                        {'to': u"orm['test.TestBaseProject']"}),
            'title': (
        ...
        u'test.testbaseproject': {
            ...
            'organization': ('django.db.models.fields.related.ForeignKey', [],
                             {'blank': 'True', 'related_name': "'organization'",
                              'null': 'True',
                              'to': u"orm['test.TestOrganization']"}),
            'owner': ('django.db.models.fields.related.ForeignKey', [],
                      {'related_name': "'owner'",
                       'to': u"orm['test.TestBaseUser']"}),
            'pitch': (
