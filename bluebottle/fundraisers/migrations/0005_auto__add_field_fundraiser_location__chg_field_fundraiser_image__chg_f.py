...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fundraiser.location'
        db.add_column(u'fundraisers_fundraiser', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.Location'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Fundraiser.image'
        db.alter_column(u'fundraisers_fundraiser', 'image', self.gf('bluebottle.utils.fields.ImageField')(max_length=255, null=True))

        # Changing field 'Fundraiser.project'
        db.alter_column(u'fundraisers_fundraiser', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project']))

        # Changing field 'Fundraiser.owner'
        db.alter_column(u'fundraisers_fundraiser', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['members.Member']))

    def backwards(self, orm):
        # Deleting field 'Fundraiser.location'
        db.delete_column(u'fundraisers_fundraiser', 'location_id')


        # Changing field 'Fundraiser.image'
        db.alter_column(u'fundraisers_fundraiser', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=255, null=True))

        # Changing field 'Fundraiser.project'
        db.alter_column(u'fundraisers_fundraiser', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['test.TestBaseProject']))

        # Changing field 'Fundraiser.owner'
        db.alter_column(u'fundraisers_fundraiser', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['test.TestBaseUser']))
