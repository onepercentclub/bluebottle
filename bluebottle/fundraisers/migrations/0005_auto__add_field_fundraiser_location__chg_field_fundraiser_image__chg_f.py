...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.add_column(u'fundraisers_fundraiser', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(
                          to=orm['geo.Location'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Fundraiser.image'
        db.alter_column(u'fundraisers_fundraiser', 'image',
                        self.gf('bluebottle.utils.fields.ImageField')(
                            max_length=255, null=True))

        # Changing field 'Fundraiser.project'
        db.alter_column(u'fundraisers_fundraiser', 'project_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(
                            to=orm['projects.Project']))

        # Changing field 'Fundraiser.owner'
        db.alter_column(u'fundraisers_fundraiser', 'owner_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(
    ...
    def backwards(self, orm):
        ...
        db.alter_column(u'fundraisers_fundraiser', 'project_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(
                            to=orm['test.TestBaseProject']))

        # Changing field 'Fundraiser.owner'
        db.alter_column(u'fundraisers_fundraiser', 'owner_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(
                            to=orm['test.TestBaseUser']))
