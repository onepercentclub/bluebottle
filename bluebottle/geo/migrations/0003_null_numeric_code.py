...
class Migration(DataMigration):
    ...
    def delete_null_numeric_code(self,objs):

        nulls = objs.objects.filter(numeric_code=None)
        nulls.delete()

    def forwards(self, orm):
        #Nothing to do, models are not allowed to have nulls for numeric_code
        pass

    def backwards(self, orm):
        
        self.delete_null_numeric_code(orm.Country)
        self.delete_null_numeric_code(orm.SubRegion)
        self.delete_null_numeric_code(orm.Region)
