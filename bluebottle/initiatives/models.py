...
from bluebottle.utils.models import BasePlatformSettings, Validator, ValidatedModelMixin, AnomizationMixin
...
class Initiative(TransitionsMixin, AnomizationMixin, NotificationModelMixin, ValidatedModelMixin, models.Model):
    status = FSMField(
