...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DonationJournal'
        db.create_table(u'journals_donationjournal', (
            ...
            ('donation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='journal_set', to=orm['donations.Donation'])),
        ))
        db.send_create_signal(u'journals', ['DonationJournal'])

        # Adding model 'OrganizationPayoutJournal'
        db.create_table(u'journals_organizationpayoutjournal', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('amount', self.gf('bluebottle.bb_projects.fields.MoneyField')(max_digits=12, decimal_places=2)),
            ('user_reference', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=400, blank=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('payout', self.gf('django.db.models.fields.related.ForeignKey')(related_name='journal_set', to=orm['payouts.OrganizationPayout'])),
        ))
        db.send_create_signal(u'journals', ['OrganizationPayoutJournal'])

        # Adding model 'ProjectPayoutJournal'
        db.create_table(u'journals_projectpayoutjournal', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('amount', self.gf('bluebottle.bb_projects.fields.MoneyField')(max_digits=12, decimal_places=2)),
            ('user_reference', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=400, blank=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('payout', self.gf('django.db.models.fields.related.ForeignKey')(related_name='journal_set', to=orm['payouts.ProjectPayout'])),
        ))
        db.send_create_signal(u'journals', ['ProjectPayoutJournal'])


    def backwards(self, orm):
        # Deleting model 'DonationJournal'
        db.delete_table(u'journals_donationjournal')

        # Deleting model 'OrganizationPayoutJournal'
        db.delete_table(u'journals_organizationpayoutjournal')

        # Deleting model 'ProjectPayoutJournal'
        db.delete_table(u'journals_projectpayoutjournal')
