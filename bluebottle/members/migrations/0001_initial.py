...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'members_member', (
            ...
            ('email', self.gf('django.db.models.fields.EmailField')(unique=True,
                                                                    max_length=254,
                                                                    db_index=True)),
            ('username',
            ...
            ('deleted',
             self.gf('django.db.models.fields.DateTimeField')(null=True,
                                                              blank=True)),
            ('user_type',
             self.gf('django.db.models.fields.CharField')(default='person',
                                                          max_length=25)),
            ('first_name',
            ...
            ('picture',
             self.gf('sorl.thumbnail.fields.ImageField')(max_length=100,
                                                         blank=True)),
            ('about_me',
             self.gf('django.db.models.fields.TextField')(max_length=265,
                                                          blank=True)),
            ('primary_language',
            ...
            ('phone_number',
             self.gf('django.db.models.fields.CharField')(max_length=50,
                                                          blank=True)),
            ('gender',
             self.gf('django.db.models.fields.CharField')(max_length=6,
                                                          blank=True)),
            ('birthdate',
