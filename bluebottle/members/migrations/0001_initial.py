...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'members_member', (
            ...
            ('about_me', self.gf('django.db.models.fields.TextField')(max_length=265, blank=True)),
            ...
            ('disable_token', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('campaign_notifications', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
