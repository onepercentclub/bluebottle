...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename field 'Member.location'
        db.rename_column(u'members_member', 'location', 'place')

        # Changing field 'Member.picture'
        db.alter_column(u'members_member', 'picture', self.gf('bluebottle.utils.fields.ImageField')(max_length=100))

    def backwards(self, orm):
        # Rename field back to 'Member.location'
        db.rename_column(u'members_member', 'place', 'location')

        # Changing field 'Member.picture'
        db.alter_column(u'members_member', 'picture', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))
