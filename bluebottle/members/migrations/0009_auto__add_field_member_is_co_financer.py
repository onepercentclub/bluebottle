...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.is_co_financer'
        db.add_column(u'members_member', 'is_co_financer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.is_co_financer'
        db.delete_column(u'members_member', 'is_co_financer')
