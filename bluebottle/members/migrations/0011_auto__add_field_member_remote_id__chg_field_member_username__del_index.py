...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.remote_id'
        db.add_column('members_member', 'remote_id',
                      self.gf('django.db.models.fields.CharField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Changing field 'Member.username'
        db.alter_column('members_member', 'username', self.gf('django.db.models.fields.CharField')(unique=True, max_length=254))

    def backwards(self, orm):
        # Deleting field 'Member.remote_id'
        db.delete_column('members_member', 'remote_id')

        # Changing field 'Member.username'
        db.alter_column('members_member', 'username', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
