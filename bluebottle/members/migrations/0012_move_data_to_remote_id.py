...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """
            If the tenant settings contains a 'remote_id' value
            in the TOKEN_AUTH settings, we copy the email address
            to the remote_id attribute. currently, all tenants use the email
