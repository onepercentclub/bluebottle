...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='memberplatformsettings',
            name='closed',
            field=bluebottle.utils.fields.CheckboxField(default=False, help_text='Require login before accessing the platform.', inline_label='Only allow users with approved email domains', verbose_name='closed'),
        ),
        migrations.AlterField(
            model_name='memberplatformsettings',
            name='confirm_signup',
            field=bluebottle.utils.fields.CheckboxField(default=False, help_text='Send confirmation email to new users', inline_label='Require users to verify their email on sign-up', verbose_name='verify email on sign up'),
        ),
        migrations.AlterField(
            model_name='memberplatformsettings',
            name='consent_link',
        ...
        migrations.AlterField(
            model_name='memberplatformsettings',
            name='email_domain',
            field=models.CharField(blank=True, null=True, verbose_name='Old email domain'),
        ),
        migrations.AlterField(
            model_name='memberplatformsettings',
            name='email_domains',
        ...
        migrations.AlterField(
            model_name='memberplatformsettings',
            name='login_methods',
            field=multiselectfield.db.fields.MultiSelectField(choices=[('password', 'Email/password combination'), ('SSO', 'Company SSO')], default=['password'], help_text='People can use any selected method to sign up or log in. For social log in options, see the ‘Social log in’ tab.', max_length=100, verbose_name='login methods'),
        ),
        migrations.AlterField(
            model_name='memberplatformsettings',
