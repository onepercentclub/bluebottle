...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # Drop the members view before altering the gender column
        # Using RunSQL to ensure it executes before the AlterField
        migrations.RunSQL(
            sql="DROP VIEW IF EXISTS members CASCADE;",
        ...
        # Note: The members view is not recreated here. If it was created by a previous
        # migration, that migration should handle recreation. If it was created manually,
        # it needs to be recreated manually after this migration runs.
        migrations.AlterField(
            model_name='member',
        ...
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('anyone', 'Anyone can create an account'), ('whitelist', 'Only people with a whitelisted email domain can create an account'), ('whitelist_and_request', 'People with a whitelisted domain can create an account; all others can request access')], default='anyone', help_text='This rule only applies to email + password sign-ups.', verbose_name='account creation rules'),
        ),
        migrations.AlterField(
            model_name='memberplatformsettings',
            name='background',
        ...
        migrations.AlterField(
            model_name='memberplatformsettings',
            name='confirm_signup',
            field=bluebottle.utils.fields.CheckboxField(default=False, help_text='This rule only applies to email + password sign-ups.', inline_label='Require users to verify their email on sign-up', verbose_name='verify email on sign up'),
        ),
        migrations.AlterField(
            model_name='memberplatformsettings',
            name='consent_link',
