...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'organizations_organization', (
            ...
            ('legal_status', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ...
        db.create_table(u'organizations_organizationaddress', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'organizations', ['OrganizationAddress'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'organizations_organizationaddress')
    ...
    models = {
        ...
        u'organizations.organizationaddress': {
