...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'organizations_organization',
                         'account_bank_country_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'organizations_organization', 'account_bank_country',
                      self.gf('django.db.models.fields.related.ForeignKey')(
                          related_name='account_bank_country', null=True,
                          to=orm['geo.Country'], blank=True),
                      keep_default=False)
        ...
        db.add_column(u'organizations_organization',
                      'account_holder_postal_code',
                      self.gf('django.db.models.fields.CharField')(default='',
                                                                   max_length=20,
                                                                   blank=True),
        ...
        db.add_column(u'organizations_organization', 'account_holder_country',
                      self.gf('django.db.models.fields.related.ForeignKey')(
                          related_name='account_holder_country', null=True,
                          to=orm['geo.Country'], blank=True),
                      keep_default=False)
