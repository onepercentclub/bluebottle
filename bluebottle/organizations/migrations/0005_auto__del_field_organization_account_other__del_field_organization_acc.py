...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Organization.registration'
        db.delete_column(u'organizations_organization', 'registration')

        # Deleting field 'Organization.account_city'
        db.delete_column(u'organizations_organization', 'account_city')

        # Deleting field 'Organization.account_name'
        db.delete_column(u'organizations_organization', 'account_name')
        ...
        # Changing field 'Organization.legal_status'
        db.alter_column(u'organizations_organization', 'legal_status', self.gf('django.db.models.fields.TextField')())
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Organization.registration'
        db.add_column(u'organizations_organization', 'registration',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.account_city'
        db.add_column(u'organizations_organization', 'account_city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Organization.account_name'
        db.add_column(u'organizations_organization', 'account_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
        ...
        # Changing field 'Organization.legal_status'
        db.alter_column(u'organizations_organization', 'legal_status', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'organizations.organization': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'legal_status': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
