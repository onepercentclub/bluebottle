    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_page', models.BooleanField(default=False, help_text='Show this page in full page width.')),
                ...
                ('publication_date', models.DateTimeField(db_index=True, help_text="When the entry goes live, status must be 'Published'", null=True, verbose_name='publication date')),
