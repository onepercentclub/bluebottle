...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='document',
            field=models.FileField(upload_to=b'pages', validators=[bluebottle.utils.validators.FileMimetypeValidator([b'application/pdf', b'application/zip', b'image/jpeg', b'image/png', b'image/gif', b'application/vnd.openxmlformats-officedocument.presentationml.presentation', b'application/vnd.openxmlformats-officedocument.wordprocessingml.document'], None, b'invalid_mimetype')], verbose_name='Document'),
        ),
        migrations.AlterField(
            model_name='page',
            name='language',
