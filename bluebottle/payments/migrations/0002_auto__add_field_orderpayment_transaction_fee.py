...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'payments_orderpayment', 'transaction_fee',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=2),
                      keep_default=False)
    ...
    models = {
        ...
        u'payments.orderpayment': {
            ...
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'payments'", 'to': "orm['{0}']".format(MODEL_MAP['order']['model'])}),
