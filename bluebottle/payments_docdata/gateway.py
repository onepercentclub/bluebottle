...
class DocdataAPIVersionPlugin(plugin.MessagePlugin):
    """
    This adds the API version number to the body element. This is required for
    the Docdata soap API.
    """
...
class DocdataClient(object):
    ...
    def __init__(self, live_mode=False):
        ...
        # The _ notation is used to assign attributes to the XML node, instead of
        # child elements.
    ...
    def create(self, merchant, payment_id, total_gross_amount, shopper, bill_to,
        ...
        merchant. If the order has been created using information on
        specific order items, the web menu can make use of this information
        by displaying a shopping cart.
        ...
        #     menuPreferences menuPreferences, shopper shopper,
        #     amount totalGrossAmount,
        #     destination billTo, string50 description, string50
        #     receiptText, xs:boolean includeCosts,
    ...
    def get_payment_menu_url(self, order_key, order_id, return_url=None,
        ...
        KBC Betaalknop and iDEAL. When the issuer_id is added to the redirect
        string, this works for iDEAL as well.
        ...
        # However, we do not need the 'redirects' app here because we know
        # the language and we can generate the exact link.
        args = {
...
class Address(object):
    ...
    def to_xml(self, factory):
        ...
        node.houseNumberAddition = unicode(self.house_number_addition) \
            if self.house_number_addition else None
