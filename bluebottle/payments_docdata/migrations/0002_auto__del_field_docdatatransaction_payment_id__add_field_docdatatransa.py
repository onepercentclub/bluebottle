...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DocdataTransaction.payment_id'
        db.delete_column(u'payments_docdata_docdatatransaction', 'payment_id')

        # Adding field 'DocdataTransaction.docdata_id'
        db.add_column(u'payments_docdata_docdatatransaction', 'docdata_id',
                      self.gf('django.db.models.fields.CharField')(default=1, unique=True, max_length=100),
                      keep_default=False)

        # Adding field 'DocdataTransaction.authorization_status'
        db.add_column(u'payments_docdata_docdatatransaction', 'authorization_status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=60, blank=True),
                      keep_default=False)

        # Adding field 'DocdataTransaction.authorization_amount'
        db.add_column(u'payments_docdata_docdatatransaction', 'authorization_amount',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'DocdataTransaction.authorization_currency'
        db.add_column(u'payments_docdata_docdatatransaction', 'authorization_currency',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'DocdataTransaction.capture_status'
        db.add_column(u'payments_docdata_docdatatransaction', 'capture_status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=60, blank=True),
                      keep_default=False)

        # Adding field 'DocdataTransaction.capture_amount'
        db.add_column(u'payments_docdata_docdatatransaction', 'capture_amount',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'DocdataTransaction.capture_currency'
        db.add_column(u'payments_docdata_docdatatransaction', 'capture_currency',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DocdataTransaction.payment_id'
        db.add_column(u'payments_docdata_docdatatransaction', 'payment_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Deleting field 'DocdataTransaction.docdata_id'
        db.delete_column(u'payments_docdata_docdatatransaction', 'docdata_id')

        # Deleting field 'DocdataTransaction.authorization_status'
        db.delete_column(u'payments_docdata_docdatatransaction', 'authorization_status')

        # Deleting field 'DocdataTransaction.authorization_amount'
        db.delete_column(u'payments_docdata_docdatatransaction', 'authorization_amount')

        # Deleting field 'DocdataTransaction.authorization_currency'
        db.delete_column(u'payments_docdata_docdatatransaction', 'authorization_currency')

        # Deleting field 'DocdataTransaction.capture_status'
        db.delete_column(u'payments_docdata_docdatatransaction', 'capture_status')

        # Deleting field 'DocdataTransaction.capture_amount'
        db.delete_column(u'payments_docdata_docdatatransaction', 'capture_amount')

        # Deleting field 'DocdataTransaction.capture_currency'
        db.delete_column(u'payments_docdata_docdatatransaction', 'capture_currency')
