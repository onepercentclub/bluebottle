...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'DocdataTransaction', fields ['docdata_id']
        db.delete_unique(u'payments_docdata_docdatatransaction', ['docdata_id'])
        ...
        db.create_table(u'payments_docdata_docdatadirectdebitpayment', (
            ...
            ('total_gross_amount', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('total_registered', self.gf('django.db.models.fields.IntegerField')(default='0.00')),
            ('total_shopper_pending', self.gf('django.db.models.fields.IntegerField')(default='0.00')),
            ('total_acquirer_pending', self.gf('django.db.models.fields.IntegerField')(default='0.00')),
            ('total_acquirer_approved', self.gf('django.db.models.fields.IntegerField')(default='0.00')),
            ('total_captured', self.gf('django.db.models.fields.IntegerField')(default='0.00')),
            ('total_refunded', self.gf('django.db.models.fields.IntegerField')(default='0.00')),
            ('total_charged_back', self.gf('django.db.models.fields.IntegerField')(default='0.00')),
        ...
        db.send_create_signal(u'payments_docdata', ['DocdataDirectdebitPayment'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'DocdataTransaction', fields ['docdata_id']
        db.create_unique(u'payments_docdata_docdatatransaction', ['docdata_id'])
