...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocdataPayment.ip_address'
        db.add_column(u'payments_docdata_docdatapayment', 'ip_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocdataPayment.ip_address'
        db.delete_column(u'payments_docdata_docdatapayment', 'ip_address')
