...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocdataTransaction.chargeback_amount'
        db.add_column(u'payments_docdata_docdatatransaction', 'chargeback_amount',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'DocdataTransaction.refund_amount'
        db.add_column(u'payments_docdata_docdatatransaction', 'refund_amount',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'DocdataTransaction.raw_response'
        db.add_column(u'payments_docdata_docdatatransaction', 'raw_response',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'DocdataTransaction.capture_currency'
        db.alter_column(u'payments_docdata_docdatatransaction', 'capture_currency', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):
        # Deleting field 'DocdataTransaction.chargeback_amount'
        db.delete_column(u'payments_docdata_docdatatransaction', 'chargeback_amount')

        # Deleting field 'DocdataTransaction.refund_amount'
        db.delete_column(u'payments_docdata_docdatatransaction', 'refund_amount')
        ...
        # Changing field 'DocdataTransaction.capture_currency'
        db.alter_column(u'payments_docdata_docdatatransaction', 'capture_currency', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        u'payments_docdata.docdatatransaction': {
            ...
            'capture_currency': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10', 'null': 'True'}),
            'capture_status': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '60', 'blank': 'True'}),
            'chargeback_amount': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            ...
            'refund_amount': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
