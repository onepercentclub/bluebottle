...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.add_column(u'payments_docdata_docdatatransaction',
                      'chargeback_amount',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'payments_docdata_docdatatransaction',
                         'chargeback_amount')
    ...
    models = {
        ...
        u'payments_docdata.docdatadirectdebitpayment': {
            ...
            'django.db.models.fields.IntegerField', [], {'default': "'0.00'"}),
