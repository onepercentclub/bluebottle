...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DocdataPayment.total_acquirer_pending'
        db.alter_column(u'payments_docdata_docdatapayment', 'total_acquirer_pending', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'DocdataPayment.total_acquirer_approved'
        db.alter_column(u'payments_docdata_docdatapayment', 'total_acquirer_approved', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'DocdataPayment.total_gross_amount'
        db.alter_column(u'payments_docdata_docdatapayment', 'total_gross_amount', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'DocdataPayment.total_refunded'
        db.alter_column(u'payments_docdata_docdatapayment', 'total_refunded', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'DocdataPayment.total_charged_back'
        db.alter_column(u'payments_docdata_docdatapayment', 'total_charged_back', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'DocdataPayment.total_shopper_pending'
        db.alter_column(u'payments_docdata_docdatapayment', 'total_shopper_pending', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'DocdataPayment.total_registered'
        db.alter_column(u'payments_docdata_docdatapayment', 'total_registered', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'DocdataPayment.total_captured'
        db.alter_column(u'payments_docdata_docdatapayment', 'total_captured', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'DocdataPayment.total_acquirer_pending'
        db.alter_column(u'payments_docdata_docdatapayment', 'total_acquirer_pending', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=2))

        # Changing field 'DocdataPayment.total_acquirer_approved'
        db.alter_column(u'payments_docdata_docdatapayment', 'total_acquirer_approved', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=2))

        # Changing field 'DocdataPayment.total_gross_amount'
        db.alter_column(u'payments_docdata_docdatapayment', 'total_gross_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=2))

        # Changing field 'DocdataPayment.total_refunded'
        db.alter_column(u'payments_docdata_docdatapayment', 'total_refunded', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=2))

        # Changing field 'DocdataPayment.total_charged_back'
        db.alter_column(u'payments_docdata_docdatapayment', 'total_charged_back', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=2))

        # Changing field 'DocdataPayment.total_shopper_pending'
        db.alter_column(u'payments_docdata_docdatapayment', 'total_shopper_pending', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=2))

        # Changing field 'DocdataPayment.total_registered'
        db.alter_column(u'payments_docdata_docdatapayment', 'total_registered', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=2))

        # Changing field 'DocdataPayment.total_captured'
        db.alter_column(u'payments_docdata_docdatapayment', 'total_captured', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=2))
    ...
    models = {
        ...
        u'payments_docdata.docdatadirectdebitpayment': {
            'Meta': {'ordering': "('-created', '-updated')", 'object_name': 'DocdataDirectdebitPayment'},
            ...
            'default_pm': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            ...
            'total_acquirer_approved': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'total_acquirer_pending': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'total_captured': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'total_charged_back': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'total_gross_amount': ('django.db.models.fields.IntegerField', [], {}),
            'total_refunded': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'total_registered': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'total_shopper_pending': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        ...
        u'payments_docdata.docdatatransaction': {
            ...
            'docdata_id': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
