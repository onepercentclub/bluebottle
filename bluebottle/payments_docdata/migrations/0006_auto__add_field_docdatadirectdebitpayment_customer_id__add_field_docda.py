...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'payments_docdata_docdatadirectdebitpayment', 'customer_id',
        ...
        db.add_column(u'payments_docdata_docdatadirectdebitpayment', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'DocdataDirectdebitPayment.last_name'
        db.add_column(u'payments_docdata_docdatadirectdebitpayment', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)
        ...
        db.add_column(u'payments_docdata_docdatadirectdebitpayment', 'postal_code',
        ...
        db.add_column(u'payments_docdata_docdatadirectdebitpayment', 'ip_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'payments_docdata_docdatadirectdebitpayment', 'customer_id')
        ...
        db.delete_column(u'payments_docdata_docdatadirectdebitpayment', 'first_name')

        # Deleting field 'DocdataDirectdebitPayment.last_name'
        db.delete_column(u'payments_docdata_docdatadirectdebitpayment', 'last_name')

        # Deleting field 'DocdataDirectdebitPayment.address'
        db.delete_column(u'payments_docdata_docdatadirectdebitpayment', 'address')

        # Deleting field 'DocdataDirectdebitPayment.postal_code'
        db.delete_column(u'payments_docdata_docdatadirectdebitpayment', 'postal_code')
        ...
        db.delete_column(u'payments_docdata_docdatadirectdebitpayment', 'ip_address')
