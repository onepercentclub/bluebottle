...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'payments_logger_paymentlogentry', (
            ...
            ('payment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payments', to=orm['payments.Payment'])),
        ))
        db.send_create_signal(u'payments_logger', ['PaymentLogEntry'])


    def backwards(self, orm):
        # Deleting model 'PaymentLogEntry'
        db.delete_table(u'payments_logger_paymentlogentry')
