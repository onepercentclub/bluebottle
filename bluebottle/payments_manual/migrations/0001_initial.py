...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ManualPayment'
        db.create_table(u'payments_manual_manualpayment', (
            ...
            ('transaction', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounting.BankTransaction'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['members.Member'])),
        ))
        db.send_create_signal(u'payments_manual', ['ManualPayment'])


    def backwards(self, orm):
        # Deleting model 'ManualPayment'
        db.delete_table(u'payments_manual_manualpayment')
    ...
    models = {
        ...
        u'payments_manual.manualpayment': {
            'Meta': {'ordering': "('-created', '-updated')", 'object_name': 'ManualPayment', '_ormbases': [u'payments.Payment']},
            ...
            'transaction': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounting.BankTransaction']"}),
