...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table('payouts_payout', (
            ...
            ('amount_raised',
             self.gf('bluebottle.bb_projects.fields.MoneyField')(max_digits=12,
                                                                 decimal_places=2)),
            ('organization_fee',
             self.gf('bluebottle.bb_projects.fields.MoneyField')(max_digits=12,
                                                                 decimal_places=2)),
        ...
        db.create_table(u'payouts_organizationpayout', (
            ...
            ('psp_fee_incl',
             self.gf('bluebottle.bb_projects.fields.MoneyField')(max_digits=12,
                                                                 decimal_places=2)),
            ('other_costs_excl',
             self.gf('bluebottle.bb_projects.fields.MoneyField')(default='0.00',
                                                                 max_digits=12,
                                                                 decimal_places=2)),
            ('other_costs_vat',
             self.gf('bluebottle.bb_projects.fields.MoneyField')(default='0.00',
        ...
        db.create_unique(u'payouts_organizationpayout',
                         ['start_date', 'end_date'])

    def backwards(self, orm):
        # Removing unique constraint on 'OrganizationPayout', fields ['start_date', 'end_date']
        db.delete_unique(u'payouts_organizationpayout',
                         ['start_date', 'end_date'])
