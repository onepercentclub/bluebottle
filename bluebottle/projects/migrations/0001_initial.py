...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'projects_projectphaselog', (
            ...
            ('phase', self.gf('django.db.models.fields.CharField')(unique=True,
                                                                   max_length=255)),
        ...
        db.create_table(u'projects_project', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(
                related_name='owner', to=orm['members.Member'])),
            ('organization',
             self.gf('django.db.models.fields.related.ForeignKey')(
                 blank=True, related_name='organization', null=True,
                 to=orm['organizations.Organization'])),
            ...
            ('status', self.gf('django.db.models.fields.related.ForeignKey')(
                to=orm['bb_projects.ProjectPhase'])),
            ('theme', self.gf('django.db.models.fields.related.ForeignKey')(
                to=orm['bb_projects.ProjectTheme'], null=True, blank=True)),
            ('favorite', self.gf('django.db.models.fields.BooleanField')(
                default=True)),
            ('description', self.gf('django.db.models.fields.TextField')(
                blank=True)),
            ('image', self.gf('sorl.thumbnail.fields.ImageField')(
            ...
            ('language', self.gf('django.db.models.fields.related.ForeignKey')(
                to=orm['utils.Language'], null=True, blank=True)),
            ('partner_organization',
             self.gf('django.db.models.fields.related.ForeignKey')(
                 to=orm['projects.PartnerOrganization'], null=True,
                 blank=True)),
            ('latitude',
            ...
            ('amount_asked',
             self.gf('bluebottle.projects.fields.MoneyField')(default=0,
                                                              null=True,
                                                              max_digits=12,
                                                              decimal_places=2,
                                                              blank=True)),
            ...
            ('story', self.gf('django.db.models.fields.TextField')(null=True,
                                                                   blank=True)),
            ('effects', self.gf('django.db.models.fields.TextField')(null=True,
                                                                     blank=True)),
            ('for_who', self.gf('django.db.models.fields.TextField')(null=True,
                                                                     blank=True)),
            ('future', self.gf('django.db.models.fields.TextField')(null=True,
                                                                    blank=True)),
            ('date_submitted',
             self.gf('django.db.models.fields.DateTimeField')(null=True,
                                                              blank=True)),
        ...
        db.create_table('projects_partnerorganization', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(unique=True,
                                                                  max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True,
                                                                  max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('image',
             self.gf('sorl.thumbnail.fields.ImageField')(max_length=255,
                                                         null=True,
                                                         blank=True)),
        ))
    ...
    models = {
        ...
        u'projects.projectphaselog': {
            ...
            'start': ('django.db.models.fields.DateTimeField', [],
                      {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'phase': ('django.db.models.fields.CharField', [],
                      {'default': "''", 'max_length': '255'})
        },
        u'taggit.tag': {
