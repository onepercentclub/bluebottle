...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ...
        (settings.ORGANIZATIONS_ORGANIZATION_MODEL.split('.')[0].lower(), '0001_initial'),
    )
    ...
    def forwards(self, orm):
        ...
        project_fields = (
            ...
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm[settings.ORGANIZATIONS_ORGANIZATION_MODEL], null=True, blank=True)),
        )

        # add some extra fields if we're using the default bluebottle project model
        ...
        db.send_create_signal(u'projects', ['ProjectDetailField'])

        # Adding model 'ProjectDetailFieldValue'
        db.create_table(u'projects_projectdetailfieldvalue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('field', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ProjectDetailField'])),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ))
        db.send_create_signal(u'projects', ['ProjectDetailFieldValue'])

        # Adding model 'ProjectDetailFieldAttribute'
        db.create_table(u'projects_projectdetailfieldattribute', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('field', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ProjectDetailField'])),
            ('attribute', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'projects', ['ProjectDetailFieldAttribute'])

        # Adding model 'ProjectDetail'
        db.create_table(u'projects_projectdetail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm[settings.PROJECTS_PROJECT_MODEL])),
            ('field', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ProjectDetailField'])),
            ('value', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'projects', ['ProjectDetail'])

        # Adding unique constraint on 'ProjectDetail', fields ['project', 'field']
        db.create_unique(u'projects_projectdetail', ['project_id', 'field_id'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'ProjectDetail', fields ['project', 'field']
        db.delete_unique(u'projects_projectdetail', ['project_id', 'field_id'])
        ...
        # Deleting model for settings.PROJECTS_PROJECT_MODEL
        db.delete_table(u'projects_project')

        # Deleting model 'ProjectDetailField'
        db.delete_table(u'projects_projectdetailfield')

        # Deleting model 'ProjectDetailFieldValue'
        db.delete_table(u'projects_projectdetailfieldvalue')

        # Deleting model 'ProjectDetailFieldAttribute'
        db.delete_table(u'projects_projectdetailfieldattribute')

        # Deleting model 'ProjectDetail'
        db.delete_table(u'projects_projectdetail')
