...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'projects_project', (
            ...
            ('phase', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ...
            ('money_asked', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True)),
            ('money_donated', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True)),
            ('money_needed', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True)),
