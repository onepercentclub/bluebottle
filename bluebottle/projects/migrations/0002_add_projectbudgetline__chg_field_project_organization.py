...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'projects_project', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organizations.Organization'], null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Project.organization'
        raise RuntimeError("Cannot reverse this migration. 'Project.organization' and its values cannot be restored.")
