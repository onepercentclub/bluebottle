...
class Migration(DataMigration):
    def forwards(self, orm):
        orm.PartnerOrganization.objects.create(name='The Cheetah Fund',
                                               slug='cheetah',
                                               description='Supporting pioneers in Africa')

    def backwards(self, orm):
        orm.PartnerOrganization.objects.filter(slug='cheetah').delete()
