...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Project.skip_monthly'
        db.add_column(u'projects_project', 'skip_monthly',
                      self.gf('django.db.models.fields.BooleanField')(
                          default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Project.skip_monthly'
        db.delete_column(u'projects_project', 'skip_monthly')
