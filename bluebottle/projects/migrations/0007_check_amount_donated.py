...
def update_money_donated(project, mchanga_object, donations):
    ...
    amount_donated = Decimal(
        get_money_total(project, donations, ['paid', 'pending'])) / 100
...
class Migration(DataMigration):
    def forwards(self, orm):
        ...
        for project in orm['projects.Project'].objects.all():
            ...
            if project.mchanga_account:
                frs = orm['mchanga.MpesaFundraiser'].objects.filter(
                    account=project.mchanga_account).all()
                if len(frs):
                    mchanga_object = frs[0]

            amount_donated = project.amount_donated
            new_amount_donated, new_amount_needed = update_money_donated(
                project, mchanga_object, donations)

            if amount_donated != new_amount_donated:
                print "Project id: {0}".format(project.id)
                f.write("Project id: {0}\n".format(project.id))
                print "Old amount donated: {0} -- New amount donated {1}".format(
                    amount_donated, new_amount_donated)
                f.write(
                    "Old amount donated: {0} -- New amount donated {1}\n".format(
                        amount_donated, new_amount_donated))
    ...
    models = {
        ...
        u'fund.donation': {
            ...
            'donation_type': ('django.db.models.fields.CharField', [],
                              {'default': "'one_off'", 'max_length': '20',
                               'db_index': 'True'}),
            'fundraiser': ('django.db.models.fields.related.ForeignKey', [],
                           {'to': u"orm['fundraisers.Fundraiser']",
                            'null': 'True', 'blank': 'True'}),
            u'id': (
                'django.db.models.fields.AutoField', [],
                {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [],
                      {'blank': 'True', 'related_name': "'donations'",
                       'null': 'True', 'to': u"orm['fund.Order']"}),
            'project': ('django.db.models.fields.related.ForeignKey', [],
                        {'to': u"orm['projects.Project']"}),
            'ready': ('django.db.models.fields.DateTimeField', [],
                      {'null': 'True', 'blank': 'True'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [],
                     {'to': u"orm['members.Member']", 'null': 'True',
                      'blank': 'True'}),
            'voucher': ('django.db.models.fields.related.ForeignKey', [],
                        {'to': u"orm['vouchers.Voucher']", 'null': 'True',
                         'blank': 'True'})
        },
        u'fund.order': {
            ...
            u'id': (
                'django.db.models.fields.AutoField', [],
                {'primary_key': 'True'}),
            'order_number': ('django.db.models.fields.CharField', [],
        ...
        u'fund.recurringdirectdebitpayment': {
            ...
            'account': ('bluebottle.utils.fields.DutchBankAccountField', [],
                        {'max_length': '10'}),
            'active': (
                'django.db.models.fields.BooleanField', [],
                {'default': 'False'}),
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [],
                     {'to': u"orm['members.Member']", 'unique': 'True'})
        },
        ...
        u'mchanga.mpesafundraiser': {
            ...
            u'id': (
                'django.db.models.fields.AutoField', [],
                {'primary_key': 'True'}),
            'link': ('django.db.models.fields.CharField', [],
                     {'max_length': '100', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [],
                     {'max_length': '100', 'blank': 'True'}),
            'owner': ('django.db.models.fields.CharField', [],
                      {'max_length': '100', 'blank': 'True'}),
            'payment_count': (
                'django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [],
                        {'to': u"orm['projects.Project']", 'null': 'True'}),
            'status': ('django.db.models.fields.CharField', [],
        ...
        u'mchanga.mpesapayment': {
            ...
            'date': (
                'django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'fundraiser_name': ('django.db.models.fields.CharField', [],
                                {'max_length': '100', 'blank': 'True'}),
            u'id': (
                'django.db.models.fields.AutoField', [],
                {'primary_key': 'True'}),
            'mchanga_account': ('django.db.models.fields.CharField', [],
                                {'max_length': '100', 'blank': 'True'}),
            'mpesa_id': ('django.db.models.fields.CharField', [],
                         {'max_length': '100', 'blank': 'True'}),
            'mpesa_name': ('django.db.models.fields.CharField', [],
                           {'max_length': '100', 'blank': 'True'}),
            'mpesa_phone': ('django.db.models.fields.CharField', [],
                            {'max_length': '100', 'blank': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [],
                        {'to': u"orm['projects.Project']", 'null': 'True'}),
            'status': ('django.db.models.fields.CharField', [],
        ...
        u'projects.project': {
            ...
            'allow_overfunding': (
                'django.db.models.fields.BooleanField', [],
                {'default': 'True'}),
            'amount_asked': ('bluebottle.projects.fields.MoneyField', [],
                             {'default': '0', 'null': 'True',
                              'max_digits': '12', 'decimal_places': '2',
                              'blank': 'True'}),
            'amount_donated': ('bluebottle.projects.fields.MoneyField', [],
                               {'default': '0', 'max_digits': '12',
                                'decimal_places': '2'}),
            'amount_needed': ('bluebottle.projects.fields.MoneyField', [],
                              {'default': '0', 'max_digits': '12',
                               'decimal_places': '2'}),
            ...
            'organization': ('django.db.models.fields.related.ForeignKey', [],
                             {'blank': 'True', 'related_name': "'organization'",
                              'null': 'True',
                              'to': u"orm['organizations.Organization']"}),
            'owner': ('django.db.models.fields.related.ForeignKey', [],
                      {'related_name': "'owner'",
                       'to': u"orm['members.Member']"}),
        ...
        u'vouchers.voucher': {
            ...
            'message': ('django.db.models.fields.TextField', [],
                        {'default': "''", 'max_length': '500',
                         'blank': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [],
                      {'related_name': "'vouchers'", 'null': 'True',
                       'to': u"orm['fund.Order']"}),
            'receiver': ('django.db.models.fields.related.ForeignKey', [],
                         {'blank': 'True', 'related_name': "'receiver'",
                          'null': 'True', 'to': u"orm['members.Member']"}),
            'receiver_email': (
            ...
            'sender': ('django.db.models.fields.related.ForeignKey', [],
                       {'blank': 'True', 'related_name': "'sender'",
                        'null': 'True', 'to': u"orm['members.Member']"}),
            'sender_email': (
                'django.db.models.fields.EmailField', [], {'max_length': '75'}),
