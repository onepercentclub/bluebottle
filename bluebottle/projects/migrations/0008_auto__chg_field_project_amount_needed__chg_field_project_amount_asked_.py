...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.amount_needed'
        db.alter_column(MODEL_MAP['project']['table'], 'amount_needed', self.gf('bluebottle.bb_projects.fields.MoneyField')(max_digits=12, decimal_places=2))

        # Changing field 'Project.amount_asked'
        db.alter_column(MODEL_MAP['project']['table'], 'amount_asked', self.gf('bluebottle.bb_projects.fields.MoneyField')(null=True, max_digits=12, decimal_places=2))

        # Changing field 'Project.amount_donated'
        db.alter_column(MODEL_MAP['project']['table'], 'amount_donated', self.gf('bluebottle.bb_projects.fields.MoneyField')(max_digits=12, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Project.amount_needed'
        db.alter_column(MODEL_MAP['project']['table'], 'amount_needed', self.gf('bluebottle.projects.fields.MoneyField')(max_digits=12, decimal_places=2))

        # Changing field 'Project.amount_asked'
        db.alter_column(MODEL_MAP['project']['table'], 'amount_asked', self.gf('bluebottle.projects.fields.MoneyField')(null=True, max_digits=12, decimal_places=2))

        # Changing field 'Project.amount_donated'
        db.alter_column(MODEL_MAP['project']['table'], 'amount_donated', self.gf('bluebottle.projects.fields.MoneyField')(max_digits=12, decimal_places=2))
