...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'projects_project', 'phase')


    def backwards(self, orm):
        # Adding field 'Project.phase'
        db.add_column(u'projects_project', 'phase',
                      self.gf('django.db.models.fields.CharField')(default='plan-new', max_length=30),
                      keep_default=False)
