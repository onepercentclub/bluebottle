...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.money_asked'
        db.delete_column(u'projects_project', 'money_asked')

        # Deleting field 'Project.money_needed'
        db.delete_column(u'projects_project', 'money_needed')

        # Deleting field 'Project.currency'
        db.delete_column(u'projects_project', 'currency')

        # Deleting field 'Project.money_donated'
        db.delete_column(u'projects_project', 'money_donated')


    def backwards(self, orm):
        # Adding field 'Project.money_asked'
        db.add_column(u'projects_project', 'money_asked',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'Project.money_needed'
        db.add_column(u'projects_project', 'money_needed',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'Project.currency'
        db.add_column(u'projects_project', 'currency',
                      self.gf('django.db.models.fields.CharField')(default='EUR', max_length='10'),
                      keep_default=False)

        # Adding field 'Project.money_donated'
        db.add_column(u'projects_project', 'money_donated',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True),
                      keep_default=False)
