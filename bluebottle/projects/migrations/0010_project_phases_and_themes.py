...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Add Phases if none are set yet
        phases = orm['bb_projects.ProjectPhase'].objects
        if not phases.count():
            call_command("loaddata", "project_phases.json")

        # Add Themes if none are set yet
        themes = orm['bb_projects.ProjectTheme'].objects
        if not themes.count():
            call_command("loaddata", "project_themes.json")
    ...
    complete_apps = ['bb_projects', 'projects']
    symmetrical = True
