...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ProjectPhase', fields ['name']
        db.create_unique(u'projects_projectphase', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProjectPhase', fields ['name']
        db.delete_unique(u'projects_projectphase', ['name'])
