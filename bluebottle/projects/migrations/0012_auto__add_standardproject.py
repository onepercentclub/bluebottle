...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StandardProject'
        db.create_table(u'projects_standardproject', (
            (u'project_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['projects.Project'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'projects', ['StandardProject'])


    def backwards(self, orm):
        # Deleting model 'StandardProject'
        db.delete_table(u'projects_standardproject')
    ...
    models = {
        ...
        u'projects.standardproject': {
            'Meta': {'ordering': "['title']", 'object_name': 'StandardProject', '_ormbases': [u'projects.Project']},
