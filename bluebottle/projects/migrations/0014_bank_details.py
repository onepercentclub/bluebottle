...
class Migration(DataMigration):
    depends_on = (
        ('organizations',
         '0002_auto__add_field_organizationdocument_created__add_field_organizationdo'),
    )
    ...
    def forwards(self, orm):
        ...
        for organization in orm['organizations.Organization'].objects.all():
            ...
            for project in organization.organization.all():
                ...
                project.account_holder_city = organization.account_holder_city
                project.account_holder_country = organization.account_holder_country
                project.account_iban = organization.account_iban
                project.account_bic = organization.account_bic
                project.account_number = organization.account_number
                project.account_bank_name = organization.account_bank_name
                project.account_bank_address = organization.account_bank_address
                project.account_bank_postal_code = organization.account_bank_postal_code
                project.account_bank_city = organization.account_bank_city
                project.account_bank_country = organization.account_bank_country
