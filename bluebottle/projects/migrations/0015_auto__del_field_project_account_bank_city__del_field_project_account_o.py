...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename field 'Project.account_number' into 'Project.account_number_old'
        db.rename_column(u'projects_project', 'account_number', 'account_number_old')

        # Rename field 'Project.account_iban' into 'Project.account_number'
        db.rename_column(u'projects_project', 'account_iban', 'account_number')

        # Changing field 'Project.account_holder_address'
        db.alter_column(u'projects_project', 'account_number', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        ...
        # Changing field 'Project.account_holder_city'
        db.alter_column(u'projects_project', 'account_holder_city', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Project.account_bic'
        db.alter_column(u'projects_project', 'account_bic', self.gf('django_iban.fields.SWIFTBICField')(max_length=11, null=True))

        # Changing field 'Project.account_holder_name'
        db.alter_column(u'projects_project', 'account_holder_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Project.account_holder_postal_code'
        db.alter_column(u'projects_project', 'account_holder_postal_code', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Project.account_holder_address'
        db.alter_column(u'projects_project', 'account_holder_address', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        # Rename field 'Project.account_number' into 'Project.account_iban'
        db.rename_column(u'projects_project', 'account_number', 'account_iban')

        # Rename field 'Project.account_number_old' into 'Project.account_number'
        db.rename_column(u'projects_project', 'account_number_old', 'account_number')
        ...
        # Changing field 'Project.account_holder_city'
        db.alter_column(u'projects_project', 'account_holder_city', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Project.account_bic'
        db.alter_column(u'projects_project', 'account_bic', self.gf('django_iban.fields.SWIFTBICField')(default='', max_length=11))

        # Changing field 'Project.account_holder_name'
        db.alter_column(u'projects_project', 'account_holder_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Project.account_holder_postal_code'
        db.alter_column(u'projects_project', 'account_holder_postal_code', self.gf('django.db.models.fields.CharField')(default='', max_length=20))

        # Changing field 'Project.account_holder_address'
        db.alter_column(u'projects_project', 'account_holder_address', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'account_number_plain': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
