...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.rename_column(u'projects_project', 'account_number',
                         'account_number_old')
        ...
        db.alter_column(u'projects_project', 'account_number',
        ...
        db.alter_column(u'projects_project', 'account_holder_city',
                        self.gf('django.db.models.fields.CharField')(
                            max_length=255, null=True))
        ...
        db.alter_column(u'projects_project', 'account_holder_name',
                        self.gf('django.db.models.fields.CharField')(
                            max_length=255, null=True))

        # Changing field 'Project.account_holder_postal_code'
        db.alter_column(u'projects_project', 'account_holder_postal_code',
                        self.gf('django.db.models.fields.CharField')(
                            max_length=20, null=True))

        # Changing field 'Project.account_holder_address'
        db.alter_column(u'projects_project', 'account_holder_address',
                        self.gf('django.db.models.fields.CharField')(
                            max_length=255, null=True))
    ...
    def backwards(self, orm):
        ...
        db.rename_column(u'projects_project', 'account_number_old',
                         'account_number')
    ...
    models = {
        ...
        u'members.member': {
            ...
            'location': ('django.db.models.fields.related.ForeignKey', [],
                         {'to': u"orm['geo.Location']", 'null': 'True',
                          'blank': 'True'}),
            'newsletter': (
            'django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'password': (
            ...
            'picture': ('bluebottle.utils.fields.ImageField', [],
                        {'max_length': '100', 'blank': 'True'}),
            'place': ('django.db.models.fields.CharField', [],
                      {'max_length': '100', 'blank': 'True'}),
        ...
        u'projects.partnerorganization': {
            ...
            u'id': (
            'django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('bluebottle.utils.fields.ImageField', [],
        ...
        u'projects.project': {
            ...
            {'blank': 'True', 'related_name': "'project_account_bank_country'",
             'null': 'True', 'to': u"orm['geo.Country']"}),
            ...
            'account_number': ('django.db.models.fields.CharField', [],
                               {'max_length': '255', 'null': 'True',
                                'blank': 'True'}),
            'account_number_plain': ('django.db.models.fields.CharField', [],
                                     {'max_length': '255', 'null': 'True',
                                      'blank': 'True'}),
            'allow_overfunding': (
            'django.db.models.fields.BooleanField', [], {'default': 'True'}),
