...
class Migration(DataMigration):
    def forwards(self, orm):
        # Merge account numbers (IBAN/other) into one field
        for project in orm['Projects.project'].objects.all():
            if not project.account_number:
                project.account_number = project.account_number_old
                project.save()

    def backwards(self, orm):
        for project in orm['Projects.project'].objects.all():
            if project.account_number == project.account_number_old:
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'account_number': ('django.db.models.fields.CharField', [],
                               {'max_length': '255', 'null': 'True',
                                'blank': 'True'}),
            'account_number_old': ('django.db.models.fields.CharField', [],
                                   {'max_length': '255', 'null': 'True',
                                    'blank': 'True'}),
            'allow_overfunding': (
            'django.db.models.fields.BooleanField', [], {'default': 'True'}),
