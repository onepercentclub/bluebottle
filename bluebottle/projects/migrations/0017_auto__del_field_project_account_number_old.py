...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Deleting field 'Project.account_number_old'
        db.delete_column(u'projects_project', 'account_number_old')

    def backwards(self, orm):
        # Adding field 'Project.account_number_old'
        db.add_column(u'projects_project', 'account_number_old',
