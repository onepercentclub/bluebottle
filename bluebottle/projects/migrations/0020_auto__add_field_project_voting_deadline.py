...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Project.voting_deadline'
        db.add_column(u'projects_project', 'voting_deadline',
                      self.gf('django.db.models.fields.DateTimeField')(
                          null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Project.voting_deadline'
        db.delete_column(u'projects_project', 'voting_deadline')
