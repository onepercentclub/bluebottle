...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Project.partner_organization'
        db.delete_column(u'projects_project', 'partner_organization_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Project.partner_organization'
        db.add_column(u'projects_project', 'partner_organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.PartnerOrganization'], null=True, blank=True),
                      keep_default=False)
