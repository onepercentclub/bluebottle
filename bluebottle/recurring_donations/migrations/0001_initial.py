    ...
    def forwards(self, orm):
        ...
        db.create_table(u'recurring_donations_monthlydonor', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(
                to=orm['members.Member'], unique=True)),
            ...
            ('amount',
             self.gf('django.db.models.fields.DecimalField')(max_digits=6,
                                                             decimal_places=2)),
            ('iban',
             self.gf('localflavor.generic.models.IBANField')(default='', max_length=34,
                                                     blank=True)),
            ('bic', self.gf('localflavor.generic.models.BICField')(default='',
                                                                max_length=11,
                                                                blank=True)),
            ('name',
        ...
        db.create_table(u'recurring_donations_monthlydonorproject', (
            (u'id',
             self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('donor', self.gf('django.db.models.fields.related.ForeignKey')(
                related_name='projects',
                to=orm['recurring_donations.MonthlyDonor'])),
        ...
        db.create_table(u'recurring_donations_monthlyproject', (
            ...
            ('batch', self.gf('django.db.models.fields.related.ForeignKey')(
                to=orm['recurring_donations.MonthlyBatch'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(
                to=orm['projects.Project'])),
            ('amount',
        ...
        db.create_table(u'recurring_donations_monthlyorder', (
            ...
            ('bic', self.gf('localflavor.generic.models.BICField')(default='',
                                                                max_length=11,
                                                                blank=True)),
            ('country', self.gf('django.db.models.fields.CharField')(default='',
                                                                     max_length=2)),
            ('processed',
             self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('error', self.gf('django.db.models.fields.CharField')(default='',
                                                                   max_length=1000,
                                                                   null=True,
                                                                   blank=True)),
        ))
        ...
        db.create_table(u'recurring_donations_monthlydonation', (
            ...
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(
                ...
                to=orm['recurring_donations.MonthlyOrder'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(
                to=orm['projects.Project'])),
            ('amount', self.gf('django.db.models.fields.PositiveIntegerField')(
                default=0)),
