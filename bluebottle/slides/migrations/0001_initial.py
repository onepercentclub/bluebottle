...
class Migration(SchemaMigration):
        ...
        db.create_table(u'slides_slide', (
            ...
            ('link_url',
             self.gf('django.db.models.fields.CharField')(max_length=400,
                                                          blank=True)),
            ('style',
             self.gf('django.db.models.fields.CharField')(default='default',
                                                          max_length=40,
                                                          blank=True)),
            ('status',
    ...
    models = {
        ...
        u'slides.slide': {
            ...
            'link_text': ('django.db.models.fields.CharField', [],
                          {'max_length': '400', 'blank': 'True'}),
            'link_url': ('django.db.models.fields.CharField', [],
                         {'max_length': '400', 'blank': 'True'}),
