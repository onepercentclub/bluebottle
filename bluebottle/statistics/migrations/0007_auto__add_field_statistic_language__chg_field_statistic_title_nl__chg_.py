...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Statistic.title_nl'
        db.alter_column(u'statistics_statistic', 'title_nl', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Statistic.title_en'
        db.alter_column(u'statistics_statistic', 'title_en', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Statistic.title_nl'
        db.alter_column(u'statistics_statistic', 'title_nl', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Statistic.title_en'
        db.alter_column(u'statistics_statistic', 'title_en', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
