...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'suggestions_suggestion', (
            ...
            ('theme', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bb_projects.ProjectTheme'])),
            ...
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='suggestions', null=True, to=orm['projects.Project'])),
        ))
    ...
    models = {
        ...
        u'suggestions.suggestion': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'suggestions'", 'null': 'True', 'to': u"orm['projects.Project']"}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'unconfirmed'", 'max_length': '64'}),
            'theme': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bb_projects.ProjectTheme']"}),
