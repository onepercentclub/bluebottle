...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tasks_task', (
            ...
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='author', to=orm['accounts.BlueBottleUser'])),
        ...
        db.create_table(u'tasks_taskmember', (
            ...
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.BlueBottleUser'])),
