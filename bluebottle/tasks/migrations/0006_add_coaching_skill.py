...
class Migration(DataMigration):
    def forwards(self, orm):
        ...
        orm['tasks.Skill'].objects.create(
            name='Coaching', name_nl='Coaching'
        )

    def backwards(self, orm):
        "Write your backwards methods here."
        orm['tasks.Skill'].objects.filter(name='Coaching').delete()
    ...
    models = {
        ...
        u'tasks.task': {
            ...
            'skill': ('django.db.models.fields.related.ForeignKey', [],
                      {'to': u"orm['tasks.Skill']", 'null': 'True'}),
        ...
        u'tasks.taskfile': {
            ...
            'task': ('django.db.models.fields.related.ForeignKey', [],
                     {'related_name': "'files'", 'to': u"orm['tasks.Task']"}),
            'title': (
            'django.db.models.fields.CharField', [], {'max_length': '255'}),
            'updated': ('django.db.models.fields.DateTimeField', [],
                        {'default': 'datetime.datetime.now', 'blank': 'True'})
        ...
        u'tasks.taskmember': {
            ...
            'task': ('django.db.models.fields.related.ForeignKey', [],
                     {'related_name': "'members'", 'to': u"orm['tasks.Task']"}),
            'time_spent': (
            'django.db.models.fields.PositiveSmallIntegerField', [],
            {'default': '0'}),
            'updated': ('django.db.models.fields.DateTimeField', [],
