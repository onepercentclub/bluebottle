...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskMember.time_spent'
        db.add_column(u'tasks_taskmember', 'time_spent',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskMember.time_spent'
        db.delete_column(u'tasks_taskmember', 'time_spent')
