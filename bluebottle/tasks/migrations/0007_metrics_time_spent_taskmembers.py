...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        with LocalTenant(connection.tenant):
            for tm in orm.TaskMember.objects.filter(status='realized'):
    ...
    models = {
        ...
        u'categories.category': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': (u'bluebottle.utils.fields.ImageField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'image_logo': (u'bluebottle.utils.fields.ImageField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '100'}),
        ...
        u'geo.location': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': (u'sorl.thumbnail.fields.ImageField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        u'members.member': {
            ...
            'can_pledge': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'picture': (u'bluebottle.utils.fields.ImageField', [], {'max_length': '100', 'blank': 'True'}),
        ...
        u'projects.project': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['categories.Category']", 'null': 'True', 'blank': 'True'}),
            'country': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['geo.Country']", 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        u'tasks.task': {
            ...
            'time_needed': ('django.db.models.fields.FloatField', [], {}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'})
        },
        u'tasks.taskfile': {
            'Meta': {'object_name': 'TaskFile'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'tasks_taskfile_related'", 'to': u"orm['members.Member']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'task': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'files'", 'to': u"orm['tasks.Task']"}),
        ...
        u'tasks.taskmember': {
            ...
            'task': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'members'", 'to': u"orm['tasks.Task']"}),
