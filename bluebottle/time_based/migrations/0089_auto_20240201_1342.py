...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('none', 'No question'), ('question', 'Ask the participant a question on the platform.'), ('link', 'Direct the participant to an external website e.g. a Google form.')], default='none', help_text='Do you want to ask any questions to your participants when they join your activity?', max_length=100, verbose_name='Registration flow'),
        ),
