    ...
    operations = [
            ...
            options={
                "permissions": (
                    ...
                    (
                        ...
                        "Can add on a date activities through the API",
                    ),
                    (
                    ...
                    (
                        ...
                        "Can view own on a date activities through the API",
                    ),
                    (
        ...
        migrations.AlterModelOptions(
            ...
            options={
                ...
                "verbose_name": "Deadline participant",
                "verbose_name_plural": "Deadline participants",
            },
        ),
        migrations.AlterModelOptions(
            ...
            options={
                "permissions": (
                    ...
                    (
                        ...
                        "Can add registation through the API",
                    ),
                    (
                        "api_change_deadlineregistration",
                        "Can change registation through the API",
                    ),
                    (
                        "api_delete_deadlineregistration",
                        "Can delete registation through the API",
                    ),
                    (
                        "api_read_own_deadlineregistration",
                        "Can view own registation through the API",
                    ),
                    (
