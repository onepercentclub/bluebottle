# Generated by Django 3.2.20 on 2024-04-22 08:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='participants', to='time_based.teamscheduleregistration')),
                ('slot', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='participants', to='time_based.teamscheduleslot')),
            ],
            options={
                'verbose_name': 'Team to schedule activities',
                'verbose_name_plural': 'Teams to schedule activities',
