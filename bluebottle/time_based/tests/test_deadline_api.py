...
class DeadlineActivityDetailAPITestCase(
...
class DeadlineActivityTransitionListAPITestCase(
...
class DeadlineRegistrationListAPITestCase(
...
class DeadlineRegistrationRelatedListAPITestCase(
...
class DeadlineRegistrationDetailAPITestCase(
...
class DeadlineRegistrationTransitionListAPITestCase(
...
class DeadlineParticipantRelatedListAPITestCase(
...
class DeadlineParticipantDetailAPITestCase(
...
class DeadlineParticipantTransitionListAPITestCase(
