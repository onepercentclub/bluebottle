...
class PeriodicActivityListAPITestCase(TimeBasedActivityListAPITestCase, APITestCase):
    ...
    fields = TimeBasedActivityListAPITestCase.fields + [
        "capacity",
        "period",
        "duration",
        "deadline",
...
class PeriodicActivityDetailAPITestCase(
    TimeBasedActivityDetailAPITestCase, APITestCase
):
    url_name = "periodic-detail"
    serializer = PeriodicActivitySerializer
    factory = PeriodicActivityFactory

    fields = TimeBasedActivityDetailAPITestCase.fields + [
        "capacity",
        "periodic",
        "duration",
        "is_online",
...
class PeriodicActivityTransitionListAPITestCase(
    TimeBasedActivityTransitionListAPITestCase, APITestCase
):
...
class PeriodicRegistrationListAPITestCase(
    TimeBasedRegistrationListAPITestCase, APITestCase
):
...
class PeriodicRegistrationRelatedListAPITestCase(
    TimeBasedRegistrationRelatedAPIListTestCase, APITestCase
):
...
class PeriodicRegistrationDetailAPITestCase(
    TimeBasedRegistrationDetailAPITestCase, APITestCase
):
...
class PeriodicRegistrationTransitionListAPITestCase(
    TimeBasedRegistrationTransitionListAPITestCase, APITestCase
):
...
class PeriodicParticipantRelatedListAPITestCase(
    TimeBasedParticipantRelatedListAPITestCase, APITestCase
):
...
class PeriodicParticipantDetailAPITestCase(
    TimeBasedParticipantDetailAPITestCase, APITestCase
):
...
class PeriodicParticipantTransitionListAPITestCase(
    TimeBasedParticipantTransitionListAPITestCase, APITestCase
):
