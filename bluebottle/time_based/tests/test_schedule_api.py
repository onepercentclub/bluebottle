...
class ScheduleActivityDetailAPITestCase(
...
class ScheduleActivityTransitionListAPITestCase(
...
class ScheduleRegistrationListAPITestCase(
...
class ScheduleRegistrationRelatedListAPITestCase(
...
class ScheduleRegistrationDetailAPITestCase(
...
class ScheduleRegistrationTransitionListAPITestCase(
...
class ScheduleParticipantRelatedListAPITestCase(
...
class ScheduleParticipantDetailAPITestCase(
...
class ScheduleParticipantTransitionListAPITestCase(
