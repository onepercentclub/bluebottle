...
class RegistrationTriggers(TriggerManager):
    ...
    triggers = [
        TransitionTrigger(
            ...
            effects=[
                TransitionEffect(
                    RegistrationStateMachine.auto_accept, conditions=[no_review_needed]
                ),
                NotificationEffect(
                    ManagerRegistrationCreatedReviewNotification,
                    conditions=[review_needed],
                ),
                NotificationEffect(UserAppliedNotification, conditions=[review_needed]),
                NotificationEffect(
                    ManagerRegistrationCreatedNotification,
                    conditions=[no_review_needed],
                ),
                NotificationEffect(
                    UserJoinedNotification, conditions=[no_review_needed]
                ),
            ],
        ),
        TransitionTrigger(
