...
from bluebottle.time_based.views import (
    ...
    PeriodActivityDetailView,
)

urlpatterns = [
    url(r"^/date$", DateActivityListView.as_view(), name="date-list"),
    url(r"^/date/(?P<pk>\d+)$", DateActivityDetailView.as_view(), name="date-detail"),
    url(
    ...
    url(r"^/date/slots$", DateSlotListView.as_view(), name="date-slot-list"),
    url(
    ...
    url(r"^/slot/ical/(?P<pk>\d+)$", ActivitySlotIcalView.as_view(), name="slot-ical"),
    url(
        r"^/date/transitions$",
    ...
    url(r"^/skills/(?P<pk>\d+)$", SkillDetail.as_view(), name="skill"),
    url(
        r"^/period/(?P<pk>\d+)$",
