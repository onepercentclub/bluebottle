...
urlpatterns = [
    ...
    re_path(
        r'^/date/(?P<activity_id>\d+)/participants$',
        DateActivityRelatedParticipantList.as_view(),
        name='date-participants'
    ),

    re_path(
        r'^/date/slots/(?P<slot_id>\d+)/participants$',
    ...
    re_path(
        r'^/date/(?P<pk>\d+)/(?P<related_field>\w+)$',
        DateSlotListView.as_view(),
        name='date-slots'
    ),
    ...
    re_path(
        r'^/date/ical/(?P<pk>\d+)/(?P<user_id>\d+)$',
