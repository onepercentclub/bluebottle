...
from bluebottle.time_based.views import (
    ...
    DeadlineActivityListView,
    DeadlineActivityDetailView,
    DeadlineRelatedRegistrationList,
    DeadlineRegistrationList,
    DeadlineRegistrationTransitionList,
    DeadlineRegistrationDetail,
    DeadlineRegistrationDocumentDetail,
    DeadlineParticipantTransitionList,
    DeadlineParticipantExportView,
    DeadlineRelatedParticipantList,
    DeadlineParticipantDetail,
)

urlpatterns = [
    url(r"^$", DeadlineActivityListView.as_view(), name="deadline-list"),
    url(
        r"^/(?P<pk>\d+)$", DeadlineActivityDetailView.as_view(), name="deadline-detail"
    ),
    url(
        r"^/transitions$",
