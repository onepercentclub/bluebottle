...
from bluebottle.time_based.views import (
    ...
    PeriodicActivityListView,
    PeriodicActivityDetailView,
    PeriodicRelatedRegistrationList,
    PeriodicRegistrationList,
    PeriodicRegistrationTransitionList,
    PeriodicRegistrationDetail,
    PeriodicRegistrationDocumentDetail,
    PeriodicParticipantTransitionList,
    PeriodicParticipantExportView,
    PeriodicRelatedParticipantList,
    PeriodicParticipantDetail,
)

urlpatterns = [
    url(r"^$", PeriodicActivityListView.as_view(), name="periodic-list"),
    url(
        r"^/(?P<pk>\d+)$", PeriodicActivityDetailView.as_view(), name="periodic-detail"
    ),
    url(
        r"^/transitions$",
