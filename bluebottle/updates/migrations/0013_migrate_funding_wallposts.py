...
def migrate_funding_wallposts(apps, schema_editor):
    ...
    for wallpost in MediaWallpost.objects.filter(content_type=funding_content_type):
    ...
    for wallpost in TextWallpost.objects.filter(content_type=funding_content_type):
        update = Update.objects.create(
            created=wallpost.created,
            activity_id=wallpost.object_id,
            message=wallpost.text,
