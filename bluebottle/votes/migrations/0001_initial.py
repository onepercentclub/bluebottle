...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Vote', fields ['project', 'voter']
        db.create_unique(u'votes_vote', ['project_id', 'voter_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'Vote', fields ['project', 'voter']
        db.delete_unique(u'votes_vote', ['project_id', 'voter_id'])
    ...
    models = {
        ...
        u'geo.location': {
            ...
            'position': ('geoposition.fields.GeopositionField', [],
                         {'max_length': '42', 'null': 'True'})
        },
        u'geo.region': {
        ...
        u'members.member': {
            ...
            'skills': ('django.db.models.fields.related.ManyToManyField', [],
                       {'symmetrical': 'False', 'to': u"orm['tasks.Skill']",
                        'null': 'True', 'blank': 'True'}),
        ...
        u'projects.project': {
            ...
            'video_url': ('django.db.models.fields.URLField', [],
                          {'default': "''", 'max_length': '100', 'null': 'True',
                           'blank': 'True'}),
            'voting_deadline': ('django.db.models.fields.DateTimeField', [],
                                {'null': 'True', 'blank': 'True'})
        },
        u'tasks.skill': {
        ...
        u'votes.vote': {
            'Meta': {'unique_together': "(('project', 'voter'),)",
                     'object_name': 'Vote'},
            'created': ('django.db.models.fields.DateTimeField', [],
                        {'default': 'datetime.datetime.now', 'blank': 'True'}),
            u'id': (
            ...
            'voter': ('django.db.models.fields.related.ForeignKey', [],
