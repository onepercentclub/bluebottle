...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wallposts_wallpost', (
            ...
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='wallpost_wallpost', null=True, to=orm['members.BookingUser'])),
            ('editor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['members.BookingUser'], null=True, blank=True)),
        ...
        db.create_table(u'wallposts_mediawallpostphoto', (
            ...
            ('deleted', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('ip_address', self.gf('django.db.models.fields.IPAddressField')(default=None, max_length=15, null=True, blank=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='mediawallpostphoto_wallpost_photo', null=True, to=orm['members.BookingUser'])),
            ('editor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['members.BookingUser'], null=True, blank=True)),
        ))
        ...
        db.create_table(u'wallposts_systemwallpost', (
            (u'wallpost_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wallposts.WallPost'], unique=True, primary_key=True)),
            ('text', self.gf('django.db.models.fields.TextField')(max_length=300, blank=True)),
        ...
        db.create_table(u'wallposts_reaction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='wallpost_reactions', to=orm['members.BookingUser'])),
            ('editor', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['members.BookingUser'])),
            ('text', self.gf('django.db.models.fields.TextField')(max_length=300)),
    ...
    models = {
        ...
        u'wallposts.mediawallpostphoto': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'mediawallpostphoto_wallpost_photo'", 'null': 'True', 'to': u"orm['members.BookingUser']"}),
            'deleted': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'editor': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['members.BookingUser']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'wallposts.reaction': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'wallpost_reactions'", 'to': u"orm['members.BookingUser']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'deleted': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'editor': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['members.BookingUser']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_address': ('django.db.models.fields.IPAddressField', [], {'default': 'None', 'max_length': '15', 'null': 'True', 'blank': 'True'}),
        ...
        u'wallposts.wallpost': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'wallpost_wallpost'", 'null': 'True', 'to': u"orm['members.BookingUser']"}),
