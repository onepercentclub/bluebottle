...
class MetricsModule(DashboardModule):
    ...
    def __init__(self, **kwargs):
        ...
        self.children = (
            ...
            {'title': 'Initiators', 'value': initiators},
            {'title': 'Supporters', 'value': supporters},
            {'title': 'Total amount raised', 'value': total_raised},

            {'title': '---'},

            {'title': 'Tasks', 'value': Task.objects.count(), 'url': task_url},
            ...
            {'title': '- Members {}'.format(last_year), 'value': TaskMember.objects.filter(task__deadline__year=last_year, status__in=allowed_statuses).distinct('member').count(), 'url': task_member_url + '?task__deadline__year={}'.format(last_year)},
            {'title': '- Members {}'.format(this_year), 'value': TaskMember.objects.filter(task__deadline__year=this_year, status__in=allowed_statuses).distinct('member').count(), 'url': task_member_url + '?task__deadline__year={}'.format(this_year)},
