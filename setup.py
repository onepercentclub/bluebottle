...
dependency_links = [
    ...
    'git+https://github.com/onepercentclub/django-fluent-contents.git@f67cb5c8ed401a85f6c2b03db54888aa3497bebf#egg=django-fluent-contents-1.2.1-goodup',
...
install_requires = [
    ...
    # Github requirements
    'django-fluent-contents==1.2.1-goodup',
