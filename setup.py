...
install_requires = [
    ...
    'django-tenant-extras@git+https://github.com/onepercentclub/django-tenant-extras.git@59c54b9fc23c4996e2a4971e31efafbb4c556066#egg=django-tenant-extras-2.0.16',
