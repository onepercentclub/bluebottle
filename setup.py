...
dependency_links = [
    ...
    'https://github.com/onepercentclub/django-tenant-extras/archive/1.7.10.zip#egg=django-tenant-extras-1.7.10',
    'https://github.com/onepercentclub/django-token-auth/archive/0.1.1.zip#egg=django-token-auth-0.1.1'
]
