...
dependency_links = [
    ...
    'git+https://github.com/onepercentclub/django-fluent-contents.git@f496282aacbb188ada87c0464f2c3fb3e1bce9a8#egg=django-fluent-contents-1.2.1-b',
...
install_requires = [
    ...
    # Github requirements
    'django-fluent-contents==1.2.1-f496282aacbb188ada87c0464f2c3fb3e1bce9a8',
