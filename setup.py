...
install_requires = [
    ...
    'bleach==2.1.1',
    'bunch==1.0.1',
    'beyonic @ git+https://github.com/beyonic/beyonic-python.git#egg=beyonic',
    'celery==3.1.24',
    ...
    'django-select-multiple-field @ git+https://github.com/st4lk/django-select-multiple-field.git@1dc7733008150a111cd141ff7c3f42bf4953dc7d#egg=django-select-multiple-field-0.5.0a-draft',
