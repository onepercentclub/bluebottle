...
dependency_links = [
    ...
    'git+https://github.com/onepercentclub/django-tenant-extras.git@1.9.2#egg=django-tenant-extras-1.9.2',
    'git+https://github.com/onepercentclub/django-token-auth.git@0.2.5#egg=django-token-auth-0.2.5'
]
...
install_requires = [
    ...
    'django-tenant-extras==1.9.2',
    'django-token-auth==0.2.5'
]
