...
dependency_links = [
    ...
    'git+https://github.com/onepercentclub/django-bb-salesforce.git@aa9613a816cb40e790f054eaf59a84cc146888b0#egg=django-bb-salesforce-1.1.18b',
    'git+https://github.com/onepercentclub/django-tenant-extras.git@2.0.2#egg=django-tenant-extras-2.0.2',
    'git+https://github.com/onepercentclub/django-token-auth.git@0.2.17#egg=django-token-auth-0.2.17',
...
install_requires = [
    ...
    'django-bb-salesforce==1.1.18b',
    'django-tenant-extras==2.0.2',
    'django-token-auth==0.2.17',
]
