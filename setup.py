...
dependency_links = [
    ...
    'https://github.com/onepercentclub/django-bb-salesforce/archive/1.1.16.zip#egg=django-bb-salesforce-1.1.16',
    'https://github.com/onepercentclub/django-tenant-extras/archive/1.9.1.zip#egg=django-tenant-extras-1.9.1',
    'https://github.com/onepercentclub/django-token-auth/archive/0.2.3.zip#egg=django-token-auth-0.2.3'
]
...
install_requires = [
    ...
    'django-bb-salesforce==1.1.16',
    'django-tenant-extras==1.9.1',
    'django-token-auth==0.2.3'
]
